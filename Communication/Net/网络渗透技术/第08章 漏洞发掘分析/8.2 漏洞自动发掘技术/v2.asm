; File Name   :	C:\Temp\v2.exe
; Format      :	Portable executable for	IBM PC (PE)
; Imagebase   :	400000
; Section 1. (virtual address 00001000)
; Virtual size			: 000080A3 (  32931.)
...
arg_4		= dword	ptr  0Ch
		...
		add	esp, 4
		cmp	eax, 1Fh
		jle	short loc_401034
		xor	eax, eax
		jmp	short loc_40105A
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401034:				; CODE XREF: main+1Ej
		mov	edx, [ebp+arg_4]
		mov	eax, [edx+4]
		push	eax
		lea	ecx, [ebp+var_20]
...
loc_40105A:				; CODE XREF: main+22j
		mov	esp, ebp
		pop	ebp
		retn
main		endp
...
printf		proc near		; CODE XREF: main+40p
...
strcpy		proc near		; CODE XREF: main+2Fp _NMSG_WRITE+94p	...
...
loc_4010CD:				; CODE XREF: strcpy+2Cj
		mov	al, [ecx]
		add	ecx, 1
		test	al, al
		jz	short loc_401113
...
loc_4010E0:				; CODE XREF: strcpy+1Bj strcpy+46j ...
		mov	eax, [ecx]
		mov	edx, 7EFEFEFFh
		add	edx, eax
		xor	eax, 0FFFFFFFFh
...
loc_401113:				; CODE XREF: strcpy+24j strcpy+5Fj
		lea	edi, [ecx-1]
		jmp	short loc_401125
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401118:				; CODE XREF: strcpy+58j
		lea	edi, [ecx-2]
		jmp	short loc_401125
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40111D:				; CODE XREF: strcpy+51j
		lea	edi, [ecx-3]
		jmp	short loc_401125
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401122:				; CODE XREF: strcpy+4Dj
		lea	edi, [ecx-4]

loc_401125:				; CODE XREF: strcpy+5j	strcpy+66j ...
		mov	ecx, [esp+4+arg_0]
		test	ecx, 3
		jz	short loc_40114E

loc_401131:				; CODE XREF: strcpy+95j
		mov	dl, [ecx]
		add	ecx, 1
		test	dl, dl
		jz	short loc_4011A0
...
loc_401149:				; CODE XREF: strcpy+B6j strcpy+D0j
		mov	[edi], edx
		add	edi, 4

loc_40114E:				; CODE XREF: strcpy+7Fj strcpy+97j
		mov	edx, 7EFEFEFFh
		mov	eax, [ecx]
		add	edx, eax
		xor	eax, 0FFFFFFFFh
...
loc_401182:				; CODE XREF: strcpy+CEj
		mov	[edi], edx
		mov	eax, [esp+8]
		pop	edi
		retn
...
loc_40118A:				; CODE XREF: strcpy+C6j
		mov	[edi], dx
		mov	eax, [esp+8]
...
loc_401197:				; CODE XREF: strcpy+BEj
		mov	[edi], dx
		mov	eax, [esp+8]
		pop	edi
		retn
...
loc_4011A0:				; CODE XREF: strcpy+88j strcpy+BAj
		mov	[edi], dl
		mov	eax, [esp+8]
		pop	edi
		retn
...
strlen		proc near		; CODE XREF: main+13p
					; _output:loc_401AC9p ...
...
loc_4011BC:				; CODE XREF: strlen+1Bj
		mov	al, [ecx]
		add	ecx, 1
		test	al, al
		jz	short loc_401213
...
loc_4011E0:				; CODE XREF: strlen+Aj	strlen+46j ...
		mov	eax, [ecx]
		mov	edx, 7EFEFEFFh
		add	edx, eax
		xor	eax, 0FFFFFFFFh
...
loc_401213:				; CODE XREF: strlen+13j strlen+5Fj
		lea	eax, [ecx-1]
		mov	ecx, [esp+arg_0]
		sub	eax, ecx
		retn
...
loc_40121D:				; CODE XREF: strlen+58j
		lea	eax, [ecx-2]
		mov	ecx, [esp+arg_0]
		sub	eax, ecx
		retn
...
loc_401227:				; CODE XREF: strlen+51j
		lea	eax, [ecx-3]
		mov	ecx, [esp+arg_0]
		sub	eax, ecx
		retn
...
loc_401231:				; CODE XREF: strlen+4Dj
		lea	eax, [ecx-4]
		mov	ecx, [esp+arg_0]
		sub	eax, ecx
		retn
...
loc_401249:				; CODE XREF: _amsg_exit+7j
		push	[esp+arg_0]
		call	_NMSG_WRITE
		push	0FFh		; int
		call	_aexit_rtn
...
loc_40126E:				; CODE XREF: fast_error_exit+7j
		push	[esp+arg_0]
		call	_NMSG_WRITE
		push	0FFh
...
loc_4012B2:				; CODE XREF: check_managed_app+Dj
					; check_managed_app+1Aj
		xor	eax, eax
		retn
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4012B5:				; CODE XREF: check_managed_app+2Cj
		xor	eax, eax
		cmp	dword ptr [ecx+84h], 0Eh
		jbe	short locret_4012D9
		cmp	[ecx+0F8h], eax
		jmp	short loc_4012D6
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4012C8:				; CODE XREF: check_managed_app+25j
		xor	eax, eax
		cmp	dword ptr [ecx+74h], 0Eh
		jbe	short locret_4012D9
		cmp	[ecx+0E8h], eax

loc_4012D6:				; CODE XREF: check_managed_app+42j
		setnz	al

locret_4012D9:				; CODE XREF: check_managed_app+3Aj
...
arg_0		= dword	ptr  8
		...
		xor	eax, eax
		jmp	short loc_4014CA
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4014BF:				; CODE XREF: _stbuf+18j
		cmp	esi, offset dword_40CBA0
		jnz	short loc_401525
		xor	eax, eax
		inc	eax

loc_4014CA:				; CODE XREF: _stbuf+1Cj
		inc	_cflush
...
loc_40150B:				; CODE XREF: _stbuf+48j _stbuf+55j
		mov	edi, [edi]
		mov	[esi+8], edi
		mov	[esi], edi
		mov	[esi+18h], ebx
...
loc_401518:				; CODE XREF: _stbuf+68j
...
loc_401525:				; CODE XREF: _stbuf+10j _stbuf+24j ...
		xor	eax, eax
		pop	esi
		retn
_stbuf		endp
...
loc_401552:				; CODE XREF: _ftbuf+6j
		mov	eax, [esp+4+arg_4]
...
loc_401562:				; CODE XREF: _ftbuf+27j
		pop	ecx

loc_401563:				; CODE XREF: _ftbuf+10j _ftbuf+31j
		pop	esi
		retn
_ftbuf		endp
...
loc_401571:				; CODE XREF: write_char+4j
		dec	dword ptr [ecx+4]
		js	short loc_401581
		mov	edx, [ecx]
		mov	[edx], al
...
loc_401581:				; CODE XREF: write_char+Fj
		movsx	eax, al
		push	ecx
		push	eax
		call	_flsbuf
...
loc_40158D:				; CODE XREF: write_char+1Aj
		cmp	eax, 0FFFFFFFFh
...
loc_401595:				; CODE XREF: write_char+Aj
					; write_char+2Bj
		inc	dword ptr [esi]
		retn
write_char	endp
...
loc_4015A0:				; CODE XREF: write_multi_char+1Fj
		mov	ecx, [ebp+arg_8]
		mov	al, [ebp+arg_0]
		dec	[ebp+arg_4]
		call	write_char
...
loc_4015B3:				; CODE XREF: write_multi_char+6j
		cmp	[ebp+arg_4], 0
		jg	short loc_4015A0

loc_4015B9:				; CODE XREF: write_multi_char+19j
		pop	esi
		pop	ebp
		retn
...
loc_4015D6:				; CODE XREF: write_string+32j
		mov	al, [ebx]
		dec	[esp+8+arg_0]
		mov	ecx, edi
		call	write_char
...
loc_4015E9:				; CODE XREF: write_string+Aj
					; write_string+10j
		cmp	[esp+8+arg_0], 0
		jg	short loc_4015D6

loc_4015F0:				; CODE XREF: write_string+18j
					; write_string+2Bj
		pop	esi
		pop	ebx
		retn
...
loc_40164F:				; CODE XREF: _output+7BBj
		mov	ecx, [ebp-70h]

loc_401652:				; CODE XREF: _output+3Bj
		inc	edi
...
loc_40167C:				; CODE XREF: _output+54j _output+59j
		xor	eax, eax

loc_40167E:				; CODE XREF: _output+68j
		...
		mov	[ebp-70h], eax
		ja	loc_401DC3
		jmp	ds:off_401DEC[eax*4]

loc_40169E:				; DATA XREF: .text:00401DF0o
		xor	eax, eax
...
loc_4016BB:				; CODE XREF: _output+85j
					; DATA XREF: .text:00401DF4o
		movsx	eax, bl
		sub	eax, 20h
		jz	short loc_4016FE
		sub	eax, 3
...
loc_4016E3:				; CODE XREF: _output+BDj
		or	dword ptr [ebp-3Ch], 4
		jmp	loc_401DC3
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4016EC:				; CODE XREF: _output+B9j
		or	dword ptr [ebp-3Ch], 1
		jmp	loc_401DC3
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4016F5:				; CODE XREF: _output+B4j
		or	byte ptr [ebp-3Ch], 80h
		jmp	loc_401DC3
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4016FE:				; CODE XREF: _output+AFj
		or	dword ptr [ebp-3Ch], 2
		jmp	loc_401DC3
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401707:				; CODE XREF: _output+85j
					; DATA XREF: .text:00401DF8o
		cmp	bl, 2Ah
...
loc_401733:				; CODE XREF: _output+F8j
		mov	eax, [ebp-58h]
		movsx	ecx, bl
		lea	eax, [eax+eax*4]
...
loc_401748:				; CODE XREF: _output+85j
					; DATA XREF: .text:00401DFCo
		and	dword ptr [ebp-40h], 0
		jmp	loc_401DC3
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401751:				; CODE XREF: _output+85j
					; DATA XREF: .text:00401E00o
		cmp	bl, 2Ah
...
loc_40177A:				; CODE XREF: _output+142j
		mov	eax, [ebp-40h]
		movsx	ecx, bl
		lea	eax, [eax+eax*4]
		lea	eax, [ecx+eax*2-30h]
...
loc_40178F:				; CODE XREF: _output+85j
					; DATA XREF: .text:00401E04o
		cmp	bl, 49h
		jz	short loc_4017C2
		cmp	bl, 68h
		jz	short loc_4017B9
...
loc_4017B0:				; CODE XREF: _output+18Aj
		or	dword ptr [ebp-3Ch], 10h
		jmp	loc_401DC3
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4017B9:				; CODE XREF: _output+185j
		or	dword ptr [ebp-3Ch], 20h
		jmp	loc_401DC3
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4017C2:				; CODE XREF: _output+180j
		mov	al, [edi]
		cmp	al, 36h
		jnz	short loc_4017DF
...
loc_4017DF:				; CODE XREF: _output+1B4j _output+1BAj
		cmp	al, 33h
...
loc_4017FA:				; CODE XREF: _output+1CFj _output+1D5j
		cmp	al, 64h
		jz	loc_401DC3
		cmp	al, 69h
		jz	loc_401DC3
...
loc_40182E:				; CODE XREF: _output+85j
					; DATA XREF: .text:off_401DECo
		mov	ecx, _pctype
...
loc_40185B:				; CODE XREF: _output+22Ej
		mov	ecx, [ebp+1DCh]
		lea	esi, [ebp-4Ch]
		mov	al, bl
		call	write_char
...
loc_401870:				; CODE XREF: _output+85j
					; DATA XREF: .text:00401E08o
		movsx	eax, bl
		cmp	eax, 67h
		jg	loc_401AD4
		cmp	eax, 65h
...
loc_4018BA:				; CODE XREF: _output+2A2j _output+4E1j
		mov	ecx, [ebp-40h]
		cmp	ecx, 0FFFFFFFFh
		jnz	short loc_4018C7
		mov	ecx, 7FFFFFFFh

loc_4018C7:				; CODE XREF: _output+2AEj
		add	dword ptr [ebp+1E4h], 4
...
loc_4018F2:				; CODE XREF: _output+2D6j
		mov	eax, [ebp-44h]
		mov	dword ptr [ebp-5Ch], 1
		jmp	loc_401B1C
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401901:				; CODE XREF: _output+28Dj _output+291j
		mov	dword ptr [ebp-6Ch], 1
		add	bl, 20h

loc_40190B:				; CODE XREF: _output+26Dj
...
loc_40192B:				; CODE XREF: _output+285j
		test	word ptr [ebp-3Ch], 830h
		jnz	short loc_401937
		or	byte ptr [ebp-3Bh], 8

loc_401937:				; CODE XREF: _output+31Fj _output+362j
		add	dword ptr [ebp+1E4h], 4
		test	word ptr [ebp-3Ch], 810h
		mov	eax, [ebp+1E4h]
		jz	short loc_4019B1
		...
		pop	ecx
		mov	[ebp-48h], eax
		jge	short loc_4019BE
		mov	dword ptr [ebp-64h], 1
		jmp	short loc_4019BE
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40196C:				; CODE XREF: _output+276j
		sub	eax, 5Ah
		jz	short loc_4019C9
		sub	eax, 9
		jz	short loc_401937
...
loc_40197D:				; CODE XREF: _output+4C5j
		or	dword ptr [ebp-3Ch], 40h

loc_401981:				; CODE XREF: _output+4E9j
		mov	dword ptr [ebp-48h], 0Ah

loc_401988:				; CODE XREF: _output+551j _output+56Aj ...
		mov	ebx, [ebp-3Ch]
		mov	esi, 8000h
		test	esi, ebx
		jz	loc_401BCB
...
loc_4019B1:				; CODE XREF: _output+338j
		mov	al, [eax-4]
		mov	[ebp-38h], al
		mov	dword ptr [ebp-48h], 1

loc_4019BE:				; CODE XREF: _output+34Fj _output+358j
		lea	eax, [ebp-38h]
		mov	[ebp-44h], eax
		jmp	loc_401CAF
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4019C9:				; CODE XREF: _output+35Dj
		add	dword ptr [ebp+1E4h], 4
		mov	eax, [ebp+1E4h]
		mov	eax, [eax-4]
		test	eax, eax
...
loc_401A01:				; CODE XREF: _output+3DCj
		and	dword ptr [ebp-5Ch], 0
		jmp	loc_401CAC
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401A0A:				; CODE XREF: _output+3C9j _output+3D0j
...
loc_401A18:				; CODE XREF: _output+307j
		jnz	short loc_401A28
		cmp	bl, 67h
		jnz	short loc_401A5F
		mov	dword ptr [ebp-40h], 1
		jmp	short loc_401A5F
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401A28:				; CODE XREF: _output:loc_401A18j
		mov	eax, 200h
		cmp	[ebp-40h], eax
		jle	short loc_401A35
		mov	[ebp-40h], eax

loc_401A35:				; CODE XREF: _output+41Ej
		mov	edi, 0A3h
		cmp	[ebp-40h], edi
		jle	short loc_401A5F
		mov	eax, [ebp-40h]
		add	eax, 15Dh
		push	eax
		call	malloc
...
loc_401A5C:				; CODE XREF: _output+441j
		mov	[ebp-40h], edi

loc_401A5F:				; CODE XREF: _output+314j _output+40Bj ...
		mov	eax, [ebp+1E4h]
		mov	ecx, [eax]
...
loc_401AAA:				; CODE XREF: _output+488j _output+48Ej
		cmp	bl, 67h
...
loc_401ABB:				; CODE XREF: _output+49Bj _output+49Fj
...
loc_401AC8:				; CODE XREF: _output+4ACj
		push	esi

loc_401AC9:				; CODE XREF: _output+401j
		call	strlen
		pop	ecx
		jmp	loc_401CAC
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401AD4:				; CODE XREF: _output+264j
		sub	eax, 69h
		jz	loc_40197D
		sub	eax, 5
		jz	loc_401B9B
...
loc_401B13:				; CODE XREF: _output+50Cj
		dec	ecx
		cmp	word ptr [eax],	0
		jz	short loc_401B20
		inc	eax
...
loc_401B1C:				; CODE XREF: _output+2EAj
		test	ecx, ecx
		jnz	short loc_401B13

loc_401B20:				; CODE XREF: _output+506j
		sub	eax, [ebp-44h]
		sar	eax, 1
		jmp	loc_401CAC
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401B2A:				; CODE XREF: _output+2CEj
		test	eax, eax
		jnz	short loc_401B36
		mov	eax, __nullstring
		mov	[ebp-44h], eax

loc_401B36:				; CODE XREF: _output+51Aj
		mov	eax, [ebp-44h]
		jmp	short loc_401B42
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401B3B:				; CODE XREF: _output+532j
		dec	ecx
		cmp	byte ptr [eax],	0
		jz	short loc_401B46
		inc	eax

loc_401B42:				; CODE XREF: _output+527j
		test	ecx, ecx
		jnz	short loc_401B3B

loc_401B46:				; CODE XREF: _output+52Dj
		sub	eax, [ebp-44h]
		jmp	loc_401CAC
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401B4E:				; CODE XREF: _output+4DCj
		mov	dword ptr [ebp-40h], 8

loc_401B55:				; CODE XREF: _output+27Cj
		mov	[ebp-68h], ecx

loc_401B58:				; CODE XREF: _output+4FFj
...
loc_401B81:				; CODE XREF: _output+4D5j
		test	byte ptr [ebp-3Ch], 80h
...
loc_401B9B:				; CODE XREF: _output+4CEj
		add	dword ptr [ebp+1E4h], 4
		...
		mov	cx, [ebp-4Ch]
		mov	[eax], cx
		jmp	short loc_401BBF
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401BBA:				; CODE XREF: _output+59Dj
		mov	ecx, [ebp-4Ch]
		mov	[eax], ecx

loc_401BBF:				; CODE XREF: _output+5A6j
		mov	dword ptr [ebp-64h], 1
		jmp	loc_401DB0
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401BCB:				; CODE XREF: _output+380j
		add	dword ptr [ebp+1E4h], 4
		test	bl, 20h
		mov	eax, [ebp+1E4h]
		jz	short loc_401BEF
...
loc_401BE6:				; CODE XREF: _output+5DBj _output+5E3j
		cdq
		jmp	short loc_401BF9
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401BE9:				; CODE XREF: _output+5CEj
		movzx	eax, word ptr [eax-4]
		jmp	short loc_401BE6
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401BEF:				; CODE XREF: _output+5C9j
		test	bl, 40h
		mov	eax, [eax-4]
		jnz	short loc_401BE6
		xor	edx, edx

loc_401BF9:				; CODE XREF: _output+39Aj _output+5D5j
		test	bl, 40h
		jz	short loc_401C13
		test	edx, edx
		jg	short loc_401C13
		jl	short loc_401C08
		test	eax, eax
		jnb	short loc_401C13

loc_401C08:				; CODE XREF: _output+5F0j
		neg	eax
		adc	edx, 0
		neg	edx
		or	byte ptr [ebp-3Bh], 1

loc_401C13:				; CODE XREF: _output+5EAj _output+5EEj ...
		test	[ebp-3Ch], esi
		mov	ebx, eax
		mov	edi, edx
...
loc_401C1E:				; CODE XREF: _output+608j
		cmp	dword ptr [ebp-40h], 0
		jge	short loc_401C2D
		mov	dword ptr [ebp-40h], 1
		jmp	short loc_401C3E
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401C2D:				; CODE XREF: _output+610j
		and	dword ptr [ebp-3Ch], 0FFFFFFF7h
		mov	eax, 200h
		cmp	[ebp-40h], eax
		jle	short loc_401C3E
		mov	[ebp-40h], eax

loc_401C3E:				; CODE XREF: _output+619j _output+627j
		mov	eax, ebx
		or	eax, edi
		jnz	short loc_401C48
		and	dword ptr [ebp-54h], 0

loc_401C48:				; CODE XREF: _output+630j
		lea	esi, [ebp+1C7h]

loc_401C4E:				; CODE XREF: _output+66Ej
		mov	eax, [ebp-40h]
...
loc_401C5E:				; CODE XREF: _output+644j
		mov	eax, [ebp-48h]
		cdq
		push	edx
		push	eax
		...
		mov	ebx, eax
		mov	edi, edx
		jle	short loc_401C7D
		add	ecx, [ebp-68h]

loc_401C7D:				; CODE XREF: _output+666j
		mov	[esi], cl
		dec	esi
		jmp	short loc_401C4E
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401C82:				; CODE XREF: _output+64Aj
		lea	eax, [ebp+1C7h]
		sub	eax, esi
		inc	esi
		...
		jnz	short loc_401CA2
		test	eax, eax
		jnz	short loc_401CAF

loc_401CA2:				; CODE XREF: _output+68Aj
		dec	dword ptr [ebp-44h]
		mov	ecx, [ebp-44h]
		mov	byte ptr [ecx],	30h
		inc	eax

loc_401CAC:				; CODE XREF: _output+3EAj _output+3F3j ...
		mov	[ebp-48h], eax

loc_401CAF:				; CODE XREF: _output+296j _output+365j ...
...
loc_401CCC:				; CODE XREF: _output+6B2j
		test	bl, 1
		jz	short loc_401CD7
...
loc_401CD7:				; CODE XREF: _output+6BDj
		test	bl, 2
		jz	short loc_401CE7
		mov	byte ptr [ebp-50h], 20h

loc_401CE0:				; CODE XREF: _output+6B8j _output+6C3j
		mov	dword ptr [ebp-54h], 1

loc_401CE7:				; CODE XREF: _output+6ADj _output+6C8j
		mov	esi, [ebp-58h]
		sub	esi, [ebp-54h]
		sub	esi, [ebp-48h]
		test	bl, 0Ch
...
loc_401D09:				; CODE XREF: _output+6E1j
...
loc_401D37:				; CODE XREF: _output+70Fj _output+714j
		cmp	dword ptr [ebp-5Ch], 0
		jz	short loc_401D87
		cmp	dword ptr [ebp-48h], 0
		jle	short loc_401D87
		mov	eax, [ebp-48h]
		mov	ebx, [ebp-44h]
		mov	[ebp-74h], eax

loc_401D4C:				; CODE XREF: _output+771j
		...
		pop	ecx
		jnz	short loc_401D4C
		jmp	short loc_401D96
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401D87:				; CODE XREF: _output+729j _output+72Fj
...
loc_401D96:				; CODE XREF: _output+755j _output+773j
...
loc_401DB0:				; CODE XREF: _output+5B4j _output+6A1j ...
...
loc_401DC3:				; CODE XREF: _output+7Fj _output+A4j ...
		mov	edi, [ebp+1E0h]
		mov	bl, [edi]
		test	bl, bl
		jnz	loc_40164F

loc_401DD3:				; CODE XREF: _output+4Bj
		pop	edi
		pop	esi

loc_401DD5:				; CODE XREF: _output+31j
		mov	ecx, [ebp+1D0h]
		mov	eax, [ebp-4Ch]
		pop	ebx
...
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
off_401DEC	dd offset loc_40182E	; DATA XREF: _output+85r
		dd offset loc_40169E
		dd offset loc_4016BB
		dd offset loc_401707
		dd offset loc_401748
		dd offset loc_401751
		dd offset loc_40178F
		dd offset loc_401870
...
__initstdio	proc near		; DATA XREF: .data:pinito
		...
		mov	eax, 200h
		jmp	short loc_401E2C
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_401E26:				; CODE XREF: __initstdio+Bj
		cmp	eax, esi
		jge	short loc_401E31
		mov	eax, esi

loc_401E2C:				; CODE XREF: __initstdio+12j
		mov	_nstream, eax

loc_401E31:				; CODE XREF: __initstdio+16j
		push	4
		push	eax
		call	calloc
		test	eax, eax
...
loc_401E62:				; CODE XREF: __initstdio+30j
					; __initstdio+49j
		xor	edx, edx
		mov	ecx, offset _iob
...
loc_401E6B:				; CODE XREF: __initstdio+6Dj
		mov	eax, __piob

loc_401E70:				; CODE XREF: __initstdio+57j
		mov	[edx+eax], ecx
		add	ecx, 20h
		add	edx, 4
...
loc_401E88:				; CODE XREF: __initstdio+A0j
		mov	eax, edx
		sar	eax, 5
...
loc_401EA5:				; CODE XREF: __initstdio+8Dj
		or	dword ptr [ecx], 0FFFFFFFFh

loc_401EA8:				; CODE XREF: __initstdio+91j
		add	ecx, 20h
		inc	edx
...
__endstdio	proc near		; DATA XREF: .data:ptermo
		call	_flushall
		cmp	_exitflag, 0
		jz	short locret_401ECB
		jmp	_fcloseall
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

locret_401ECB:				; CODE XREF: __endstdio+Cj
		retn
__endstdio	endp
...
loc_401EF1:				; CODE XREF: __crtExitProcess+Dj
...
loc_401F01:				; CODE XREF: _initterm+14j
		mov	eax, [esi]
		test	eax, eax
		jz	short loc_401F09
		call	eax

loc_401F09:				; CODE XREF: _initterm+9j
		add	esi, 4

loc_401F0C:				; CODE XREF: _initterm+3j
		cmp	esi, [esp+arg_0]
		jb	short loc_401F01
		pop	esi
		retn
...
loc_401F1B:				; CODE XREF: _initterm_e+1Aj
		test	eax, eax
...
loc_401F27:				; CODE XREF: _initterm_e+Fj
		add	esi, 4

loc_401F2A:				; CODE XREF: _initterm_e+5j
		cmp	esi, [esp+arg_0]
		jb	short loc_401F1B

loc_401F30:				; CODE XREF: _initterm_e+9j
		pop	esi
		retn
_initterm_e	endp
...
loc_401F42:				; CODE XREF: _cinit+7j
		push	esi
		push	edi
		...
		cmp	ecx, edi
		mov	esi, ecx
		jnb	short loc_401F6D

loc_401F56:				; CODE XREF: _cinit+35j
		test	eax, eax
...
loc_401F62:				; CODE XREF: _cinit+2Cj
		add	esi, 4
		cmp	esi, edi
		jb	short loc_401F56
		test	eax, eax
...
loc_401F6D:				; CODE XREF: _cinit+22j
		...
		cmp	eax, edi
		pop	ecx
		jnb	short loc_401F97

loc_401F88:				; CODE XREF: _cinit+63j
		mov	eax, [esi]
		test	eax, eax
		jz	short loc_401F90
		call	eax

loc_401F90:				; CODE XREF: _cinit+5Aj
		add	esi, 4
		cmp	esi, edi
		jb	short loc_401F88

loc_401F97:				; CODE XREF: _cinit+54j
		xor	eax, eax

loc_401F99:				; CODE XREF: _cinit+26j _cinit+39j
		pop	edi
		pop	esi
		retn
_cinit		endp
...
loc_401FBC:				; CODE XREF: doexit+Ej
		cmp	[ebp+arg_4], 0
		mov	al, [ebp+arg_8]
...
loc_401FE6:				; CODE XREF: doexit+65j
		mov	eax, [eax]
		test	eax, eax
		jz	short loc_401FEE
		call	eax

loc_401FEE:				; CODE XREF: doexit+4Ej
		mov	eax, __onexitend
		sub	eax, 4
		cmp	eax, __onexitbegin

loc_401FFC:				; CODE XREF: doexit+48j
		mov	__onexitend, eax
		jnb	short loc_401FE6

loc_402003:				; CODE XREF: doexit+3Cj
		mov	eax, offset __xp_a
		mov	esi, offset __xp_z
		cmp	eax, esi
		mov	edi, eax
		jnb	short loc_402022

loc_402013:				; CODE XREF: doexit+84j
		mov	eax, [edi]
		test	eax, eax
		jz	short loc_40201B
		call	eax

loc_40201B:				; CODE XREF: doexit+7Bj
		add	edi, 4
		cmp	edi, esi
		jb	short loc_402013

loc_402022:				; CODE XREF: doexit+32j doexit+75j
		mov	eax, offset __xt_a
		mov	esi, offset __xt_z
		cmp	eax, esi
		mov	edi, eax
		jnb	short loc_402041

loc_402032:				; CODE XREF: doexit+A3j
		mov	eax, [edi]
		test	eax, eax
		jz	short loc_40203A
		call	eax

loc_40203A:				; CODE XREF: doexit+9Aj
		add	edi, 4
		cmp	edi, esi
		jb	short loc_402032

loc_402041:				; CODE XREF: doexit+94j
		cmp	dword ptr [ebp+arg_8], 0
		pop	edi
		pop	esi
		jnz	short loc_40205B
		push	[ebp+arg_0]
		mov	_C_Exit_Done, 1
		call	__crtExitProcess

loc_40205B:				; CODE XREF: doexit+ABj
		pop	ebp
		retn
doexit		endp ; sp = -4
...
_cexit		proc near		; CODE XREF: mainCRTStartup:loc_401460p
		push	1
		push	0
		push	0
		call	doexit
...
_c_exit		proc near		; CODE XREF: mainCRTStartup:loc_40148Dp
		push	1
		push	1
		push	0
		call	doexit
...
loc_4020C3:				; CODE XREF: _NMSG_WRITE+33j
...
loc_4020D2:				; CODE XREF: _NMSG_WRITE+2Dj
		mov	esi, eax
		shl	esi, 3
		cmp	ecx, rterrs[esi]
		jnz	loc_4021F8
...
loc_402102:				; CODE XREF: _NMSG_WRITE+56j
		cmp	ecx, 0FCh
		jz	loc_4021F8
		push	104h
		lea	eax, [ebp-80h]
...
loc_402138:				; CODE XREF: _NMSG_WRITE+89j
		lea	edi, [ebp-80h]
		mov	eax, edi
		push	eax
		call	strlen
...
loc_40216C:				; CODE XREF: _NMSG_WRITE+ABj
		push	edi
		call	strlen
...
loc_4021D0:				; CODE XREF: _NMSG_WRITE+4Ej
					; _NMSG_WRITE+5Fj
		push	edx
		lea	eax, [ebp+94h]
		push	eax
...
loc_4021F8:				; CODE XREF: _NMSG_WRITE+40j
					; _NMSG_WRITE+6Bj ...
		lea	esp, [ebp-8Ch]
		mov	ecx, [ebp+88h]
		call	__security_check_cookie
...
loc_40221A:				; CODE XREF: _GET_RTERRMSG+13j
		cmp	ecx, rterrs[eax*8]
		jz	short loc_402229
		inc	eax
		cmp	eax, 13h
...
loc_402229:				; CODE XREF: _GET_RTERRMSG+Dj
		shl	eax, 3
		cmp	ecx, rterrs[eax]
...
loc_40223B:				; CODE XREF: _GET_RTERRMSG+1Ej
		xor	eax, eax
		retn
_GET_RTERRMSG	endp
...
_FF_MSGBANNER	proc near		; CODE XREF: _amsg_exit+9p
		...
		jz	short loc_402255
		test	eax, eax
		jnz	short locret_402276
		cmp	__app_type, 1
		jnz	short locret_402276

loc_402255:				; CODE XREF: _FF_MSGBANNER+8j
		push	0FCh
		call	_NMSG_WRITE
		mov	eax, _adbgmsg
		test	eax, eax
...
loc_40226B:				; CODE XREF: _FF_MSGBANNER+29j
		push	0FFh
		call	_NMSG_WRITE
		pop	ecx

locret_402276:				; CODE XREF: _FF_MSGBANNER+Cj
					; _FF_MSGBANNER+15j
		retn
_FF_MSGBANNER	endp
...
loc_402283:				; CODE XREF: xcptlookup+1Fj
		cmp	[eax], edx
		jz	short loc_402298
		lea	esi, [ecx+ecx*2]
		add	eax, 0Ch
...
loc_402298:				; CODE XREF: xcptlookup+Ej
		lea	ecx, [ecx+ecx*2]
		lea	ecx, ds:40CE78h[ecx*4]
		cmp	eax, ecx
		pop	esi
		jnb	short loc_4022AB
		cmp	[eax], edx
		jz	short locret_4022AD

loc_4022AB:				; CODE XREF: xcptlookup+2Ej
		xor	eax, eax

locret_4022AD:				; CODE XREF: xcptlookup+32j
		retn
xcptlookup	endp
...
loc_4022C0:				; CODE XREF: _XcptFilter+25j
		cmp	[ecx], edx
		jz	short loc_4022D5
		lea	esi, [eax+eax*2]
		add	ecx, 0Ch
...
loc_4022D5:				; CODE XREF: _XcptFilter+14j
		lea	eax, [eax+eax*2]
		lea	eax, ds:40CE78h[eax*4]
		cmp	ecx, eax
		jnb	short loc_4022E7
		cmp	[ecx], edx
		jz	short loc_4022E9

loc_4022E7:				; CODE XREF: _XcptFilter+33j
		xor	ecx, ecx

loc_4022E9:				; CODE XREF: _XcptFilter+37j
		test	ecx, ecx
		jz	loc_402412
		mov	ebx, [ecx+8]
		test	ebx, ebx
...
loc_40230D:				; CODE XREF: _XcptFilter+51j
		cmp	ebx, 1
		jz	loc_40240D
...
loc_40234F:				; CODE XREF: _XcptFilter+A8j
		and	dword ptr [esi], 0
		add	esi, 0Ch
		dec	edx
		jnz	short loc_40234F

loc_402358:				; CODE XREF: _XcptFilter+93j
		mov	ecx, [ecx]
		cmp	ecx, 0C000008Eh
		mov	esi, _fpecode
		jnz	short loc_402374
		mov	_fpecode, 83h
		jmp	short loc_4023EA
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_402374:				; CODE XREF: _XcptFilter+B8j
		cmp	ecx, 0C0000090h
		jnz	short loc_402388
		mov	_fpecode, 81h
		jmp	short loc_4023EA
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_402388:				; CODE XREF: _XcptFilter+CCj
		cmp	ecx, 0C0000091h
...
loc_40239C:				; CODE XREF: _XcptFilter+E0j
		cmp	ecx, 0C0000093h
...
loc_4023B0:				; CODE XREF: _XcptFilter+F4j
		cmp	ecx, 0C000008Dh
		jnz	short loc_4023C4
		mov	_fpecode, 82h
		jmp	short loc_4023EA
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4023C4:				; CODE XREF: _XcptFilter+108j
		cmp	ecx, 0C000008Fh
...
loc_4023D8:				; CODE XREF: _XcptFilter+11Cj
		cmp	ecx, 0C0000092h
		jnz	short loc_4023EA
		mov	_fpecode, 8Ah

loc_4023EA:				; CODE XREF: _XcptFilter+C4j
					; _XcptFilter+D8j ...
		push	_fpecode
		push	8
		call	ebx
...
loc_4023FD:				; CODE XREF: _XcptFilter+7Ej
		and	dword ptr [ecx+8], 0
		push	eax
		call	ebx

loc_402404:				; CODE XREF: _XcptFilter+14Dj
		mov	eax, [ebp+arg_0]
		pop	ecx
		mov	_pxcptinfoptrs,	eax

loc_40240D:				; CODE XREF: _XcptFilter+62j
		or	eax, 0FFFFFFFFh
		jmp	short loc_40241B
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_402412:				; CODE XREF: _XcptFilter+3Dj
					; _XcptFilter+48j
		push	[ebp+arg_4]
		call	ds:__imp__UnhandledExceptionFilter@4 ; __declspec(dllimport) UnhandledExceptionFilter(x)

loc_40241B:				; CODE XREF: _XcptFilter+5Aj
					; _XcptFilter+162j
		pop	esi
		pop	ebx
		pop	ebp
...
loc_402437:				; CODE XREF: __CppXcptFilter+9j
		xor	eax, eax
		retn
...
_setenvp	proc near		; CODE XREF: mainCRTStartup:loc_40140Ap
		push	ebx
		xor	ebx, ebx
...
loc_40244C:				; CODE XREF: _setenvp+Bj
		mov	esi, _aenvptr
		xor	edi, edi
		cmp	esi, ebx
		jnz	short loc_40246A
		jmp	short loc_40248A
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40245A:				; CODE XREF: _setenvp+34j
		cmp	al, 3Dh
		jz	short loc_40245F
		inc	edi

loc_40245F:				; CODE XREF: _setenvp+22j
		push	esi
		call	strlen
		pop	ecx
		lea	esi, [esi+eax+1]

loc_40246A:				; CODE XREF: _setenvp+1Cj
		mov	al, [esi]
		cmp	al, bl
		...
		pop	ecx
		mov	_environ, edi
		jnz	short loc_40248F

loc_40248A:				; CODE XREF: _setenvp+1Ej
		or	eax, 0FFFFFFFFh
		jmp	short loc_4024E7
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40248F:				; CODE XREF: _setenvp+4Ej
		mov	esi, _aenvptr
		push	ebp
		jmp	short loc_4024C2
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_402498:				; CODE XREF: _setenvp+8Aj
		push	esi
		call	strlen
		mov	ebp, eax
		inc	ebp
...
loc_4024C0:				; CODE XREF: _setenvp+6Bj
		add	esi, ebp

loc_4024C2:				; CODE XREF: _setenvp+5Cj
		cmp	[esi], bl
...
loc_4024E5:				; CODE XREF: _setenvp+C5j
		pop	ecx
		pop	ebp

loc_4024E7:				; CODE XREF: _setenvp+53j
		pop	edi
		pop	esi
		pop	ebx
		retn
...
loc_4024EB:				; CODE XREF: _setenvp+78j
		push	_environ
		call	free
		mov	_environ, ebx
		or	eax, 0FFFFFFFFh
...
loc_402524:				; CODE XREF: parse_cmdline+18j
					; parse_cmdline+65j ...
		...
		mov	edx, ecx
		mov	cl, 22h
		jmp	short loc_402564
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_402537:				; CODE XREF: parse_cmdline+26j
		inc	dword ptr [esi]
		test	edi, edi
		jz	short loc_402542
		mov	cl, [eax]
...
loc_402542:				; CODE XREF: parse_cmdline+3Aj
		mov	cl, [eax]
		movzx	ebx, cl
		inc	eax
...
loc_40255C:				; CODE XREF: parse_cmdline+54j
		inc	eax

loc_40255D:				; CODE XREF: parse_cmdline+4Ej
		test	cl, cl
		mov	ebx, [ebp+arg_4]
		jz	short loc_402596

loc_402564:				; CODE XREF: parse_cmdline+34j
		test	edx, edx
...
loc_402572:				; CODE XREF: parse_cmdline+6Aj
		test	edi, edi
		jz	short loc_40257A
		mov	byte ptr [edi-1], 0

loc_40257A:				; CODE XREF: parse_cmdline+73j
					; parse_cmdline+96j
		and	[ebp+var_4], 0

loc_40257E:				; CODE XREF: parse_cmdline+157j
		cmp	byte ptr [eax],	0
		jz	loc_40265D

loc_402587:				; CODE XREF: parse_cmdline+93j
		mov	cl, [eax]
		cmp	cl, 20h
		jz	short loc_402593
		cmp	cl, 9
...
loc_402593:				; CODE XREF: parse_cmdline+8Bj
		inc	eax
		jmp	short loc_402587
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_402596:				; CODE XREF: parse_cmdline+61j
		dec	eax
		jmp	short loc_40257A
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_402599:				; CODE XREF: parse_cmdline+90j
		cmp	byte ptr [eax],	0
		jz	loc_40265D
		cmp	[ebp+arg_0], 0
		jz	short loc_4025B1
...
loc_4025B1:				; CODE XREF: parse_cmdline+A5j
		inc	dword ptr [ebx]

loc_4025B3:				; CODE XREF: parse_cmdline+145j
		xor	ebx, ebx
		inc	ebx
		xor	edx, edx
		jmp	short loc_4025BC
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4025BA:				; CODE XREF: parse_cmdline+BEj
		inc	eax
		inc	edx

loc_4025BC:				; CODE XREF: parse_cmdline+B7j
...
loc_4025DD:				; CODE XREF: parse_cmdline+CEj
					; parse_cmdline+D6j
		xor	ebx, ebx

loc_4025DF:				; CODE XREF: parse_cmdline+DAj
		xor	ecx, ecx
		cmp	[ebp+var_4], ecx
		setz	cl
		mov	[ebp+var_4], ecx

loc_4025EA:				; CODE XREF: parse_cmdline+C8j
		shr	edx, 1

loc_4025EC:				; CODE XREF: parse_cmdline+C3j
		test	edx, edx
		jz	short loc_4025FD

loc_4025F0:				; CODE XREF: parse_cmdline+FAj
		test	edi, edi
		jz	short loc_4025F8
		mov	byte ptr [edi],	5Ch
		inc	edi

loc_4025F8:				; CODE XREF: parse_cmdline+F1j
		inc	dword ptr [esi]
		dec	edx
		jnz	short loc_4025F0

loc_4025FD:				; CODE XREF: parse_cmdline+EDj
		mov	cl, [eax]
		test	cl, cl
		jz	short loc_40264B
		cmp	[ebp+var_4], 0
		jnz	short loc_402613
		cmp	cl, 20h
		jz	short loc_40264B
		cmp	cl, 9
		jz	short loc_40264B

loc_402613:				; CODE XREF: parse_cmdline+106j
		test	ebx, ebx
		jz	short loc_402645
		test	edi, edi
		jz	short loc_402634
...
loc_40262D:				; CODE XREF: parse_cmdline+124j
		mov	cl, [eax]
		mov	[edi], cl
		inc	edi
...
loc_402634:				; CODE XREF: parse_cmdline+118j
		movzx	ecx, cl
...
loc_402643:				; CODE XREF: parse_cmdline+131j
					; parse_cmdline+13Dj
		inc	dword ptr [esi]

loc_402645:				; CODE XREF: parse_cmdline+114j
		inc	eax
		jmp	loc_4025B3
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40264B:				; CODE XREF: parse_cmdline+100j
					; parse_cmdline+10Bj ...
		test	edi, edi
		jz	short loc_402653
		mov	byte ptr [edi],	0
...
loc_402653:				; CODE XREF: parse_cmdline+14Cj
		inc	dword ptr [esi]
		mov	ebx, [ebp+arg_4]
		jmp	loc_40257E
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40265D:				; CODE XREF: parse_cmdline+80j
					; parse_cmdline+9Bj
		mov	eax, [ebp+arg_0]
		test	eax, eax
		jz	short loc_402667
...
loc_402667:				; CODE XREF: parse_cmdline+161j
		inc	dword ptr [ebx]
		pop	edi
		pop	ebx
		leave
...
loc_402684:				; CODE XREF: _setargv+10j
		push	104h
...
loc_4026B3:				; CODE XREF: _setargv+3Dj
		mov	ebx, esi

loc_4026B5:				; CODE XREF: _setargv+44j
		lea	eax, [ebp+var_4]
		push	eax
		push	edi
		lea	esi, [ebp+var_8]
...
loc_4026E5:				; CODE XREF: _setargv+71j
		lea	eax, [ebp+var_4]
		push	eax
		lea	ecx, [esi+edi]
		push	edi
...
loc_40270A:				; CODE XREF: _setargv+76j
		pop	edi
		pop	esi
		pop	ebx
		leave
...
loc_40273F:				; CODE XREF: __crtGetEnvironmentStringsA+22j
...
loc_402753:				; CODE XREF: __crtGetEnvironmentStringsA+39j
		mov	eax, dword_40D598

loc_402758:				; CODE XREF: __crtGetEnvironmentStringsA+1Aj
					; __crtGetEnvironmentStringsA+42j
		cmp	eax, 1
		jnz	short loc_4027DA

loc_40275D:				; CODE XREF: __crtGetEnvironmentStringsA+2Ej
		cmp	esi, ebx
...
loc_402769:				; CODE XREF: __crtGetEnvironmentStringsA+50j
		cmp	[esi], bx
		mov	eax, esi
		jz	short loc_40277E

loc_402770:				; CODE XREF: __crtGetEnvironmentStringsA+66j
...
loc_40277E:				; CODE XREF: __crtGetEnvironmentStringsA+5Fj
...
loc_4027CB:				; CODE XREF: __crtGetEnvironmentStringsA+ACj
		mov	ebx, [esp+18h+var_8]

loc_4027CF:				; CODE XREF: __crtGetEnvironmentStringsA+8Cj
					; __crtGetEnvironmentStringsA+9Bj
		push	esi
		call	ds:__imp__FreeEnvironmentStringsW@4 ; __declspec(dllimport) FreeEnvironmentStringsW(x)
		mov	eax, ebx
		jmp	short loc_40282A
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4027DA:				; CODE XREF: __crtGetEnvironmentStringsA+4Cj
		cmp	eax, ebp
		jz	short loc_4027E6
		cmp	eax, ebx
		jz	short loc_4027E6

loc_4027E2:				; CODE XREF: __crtGetEnvironmentStringsA+58j
					; __crtGetEnvironmentStringsA+E1j
		xor	eax, eax
		jmp	short loc_40282A
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4027E6:				; CODE XREF: __crtGetEnvironmentStringsA+CDj
...
loc_4027F6:				; CODE XREF: __crtGetEnvironmentStringsA+EAj
...
loc_402800:				; CODE XREF: __crtGetEnvironmentStringsA+E5j
		sub	eax, esi
		inc	eax
		mov	ebp, eax
		push	ebp
...
loc_402816:				; CODE XREF: __crtGetEnvironmentStringsA+101j
		push	ebp
		push	esi
		push	edi
		call	memcpy
...
loc_402821:				; CODE XREF: __crtGetEnvironmentStringsA+105j
		push	esi
		call	ds:__imp__FreeEnvironmentStringsA@4 ; __declspec(dllimport) FreeEnvironmentStringsA(x)
		mov	eax, edi

loc_40282A:				; CODE XREF: __crtGetEnvironmentStringsA+C9j
...
loc_40284B:				; CODE XREF: _ioinit+10j
		mov	__pioinfo, eax
		mov	_nhandle, 20h
		lea	ecx, [eax+100h]
		jmp	short loc_40287C
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_402862:				; CODE XREF: _ioinit+4Dj
...
loc_40287C:				; CODE XREF: _ioinit+2Fj
		cmp	eax, ecx
		jb	short loc_402862
		push	ebx
		push	esi
...
loc_4028BA:				; CODE XREF: _ioinit+85j
		cmp	_nhandle, esi
		jge	short loc_402914
		mov	edi, offset dword_40D984

loc_4028C7:				; CODE XREF: _ioinit+D9j
		push	100h
		call	malloc
		test	eax, eax
		pop	ecx
...
loc_4028E7:				; CODE XREF: _ioinit+CEj
		or	dword ptr [eax], 0FFFFFFFFh
		mov	byte ptr [eax+4], 0
		mov	byte ptr [eax+5], 0Ah
		mov	ecx, [edi]
...
loc_4028FD:				; CODE XREF: _ioinit+B4j
		cmp	eax, ecx
		jb	short loc_4028E7
		add	edi, 4
		cmp	_nhandle, esi
...
loc_40290E:				; CODE XREF: _ioinit+A3j
		mov	esi, _nhandle

loc_402914:				; CODE XREF: _ioinit+8Fj _ioinit+DBj
		xor	edi, edi
		test	esi, esi
		jle	short loc_402960

loc_40291A:				; CODE XREF: _ioinit+12Dj
		mov	eax, [ebx]
		cmp	eax, 0FFFFFFFFh
		jz	short loc_402957
		mov	cl, [ebp+0]
...
loc_402957:				; CODE XREF: _ioinit+EEj _ioinit+F6j ...
		inc	edi
		inc	ebp
		add	ebx, 4
		cmp	edi, esi
...
loc_402960:				; CODE XREF: _ioinit+E7j
		pop	ebp

loc_402961:				; CODE XREF: _ioinit+63j _ioinit+6Fj
		xor	ebx, ebx

loc_402963:				; CODE XREF: _ioinit+194j
		mov	eax, __pioinfo
		lea	esi, [eax+ebx*8]
		cmp	dword ptr [esi], 0FFFFFFFFh
		...
		jnz	short loc_40297D
		push	0FFFFFFF6h
		pop	eax
		jmp	short loc_402987
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40297D:				; CODE XREF: _ioinit+145j
		mov	eax, ebx
		dec	eax
		neg	eax
		sbb	eax, eax
...
loc_402987:				; CODE XREF: _ioinit+14Aj
		push	eax
		call	ds:__imp__GetStdHandle@4 ; __declspec(dllimport) GetStdHandle(x)
		mov	edi, eax
		cmp	edi, 0FFFFFFFFh
...
loc_4029AC:				; CODE XREF: _ioinit+162j _ioinit+16Dj
		or	byte ptr [esi+4], 40h
		jmp	short loc_4029C1
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4029B2:				; CODE XREF: _ioinit+179j
		cmp	eax, 3
...
loc_4029BD:				; CODE XREF: _ioinit+13Dj
		or	byte ptr [esi+4], 80h

loc_4029C1:				; CODE XREF: _ioinit+17Fj _ioinit+184j ...
		inc	ebx
		cmp	ebx, 3
		jl	short loc_402963
		push	_nhandle
...
loc_4029D8:				; CODE XREF: _ioinit+15j
		add	esp, 44h
		retn
_ioinit		endp
...
loc_4029E2:				; CODE XREF: _ioterm+1Fj
		mov	eax, [esi]
		test	eax, eax
		jz	short loc_4029F2
		push	eax
...
loc_4029F2:				; CODE XREF: _ioterm+Aj
		add	esi, 4
...
_RTC_Initialize	proc near		; CODE XREF: mainCRTStartup:loc_4013CBp
		push	0Ch
		push	offset dword_40A4D0
		call	__SEH_prolog
		mov	dword ptr [ebp-1Ch], offset dword_40B290

loc_402A12:				; CODE XREF: _RTC_Initialize+3Cj
		cmp	dword ptr [ebp-1Ch], offset __rtc_izz
		jnb	short loc_402A3D
...
loc_402A33:				; CODE XREF: _RTC_Initialize+27j
...
loc_402A3D:				; CODE XREF: _RTC_Initialize+1Aj
		call	__SEH_epilog
		retn
...
_RTC_Terminate	proc near		; DATA XREF: _cinit:loc_401F6Do
		push	0Ch
		push	offset dword_40A4E0
		call	__SEH_prolog
		mov	dword ptr [ebp-1Ch], offset dword_40B498

loc_402A56:				; CODE XREF: _RTC_Terminate+3Cj
...
loc_402A77:				; CODE XREF: _RTC_Terminate+27j
					; _RTC_Terminate+2Bj
		or	dword ptr [ebp-4], 0FFFFFFFFh
		add	dword ptr [ebp-1Ch], 4
		jmp	short loc_402A56
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_402A81:				; CODE XREF: _RTC_Terminate+1Aj
		call	__SEH_epilog
		retn
...
loc_402A9D:				; CODE XREF: __heap_select+7j
					; __heap_select+10j
		push	3
		pop	eax
		retn
...
loc_402AEB:				; CODE XREF: _heap_init+1Ej
		xor	eax, eax
		retn
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_402AEE:				; CODE XREF: _heap_init+2Dj
					; _heap_init+3Cj
		xor	eax, eax
		inc	eax
		retn
...
loc_402B1E:				; CODE XREF: _heap_term+5Cj
		push	4000h
		push	100000h
		push	dword ptr [esi]
...
loc_402B52:				; CODE XREF: _heap_term+19j
...
loc_402B64:				; CODE XREF: _heap_term+7j
		push	_crtheap
		call	ds:__imp__HeapDestroy@4	; __declspec(dllimport)	HeapDestroy(x)
		retn
_heap_term	endp
...
loc_402C0C:				; CODE XREF: _except_handler3+B2j
		cmp	esi, 0FFFFFFFFh
		jz	short loc_402C8E
		lea	ecx, [esi+esi*2]
		mov	eax, [edi+ecx*4+4]
...
loc_402C75:				; CODE XREF: _except_handler3+4Ej
...
loc_402C80:				; CODE XREF: _except_handler3+6Aj
		mov	eax, 0
		jmp	short loc_402CAA
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_402C87:				; CODE XREF: _except_handler3+3Ej
		mov	eax, [ebp+arg_0]
		or	dword ptr [eax+4], 8

loc_402C8E:				; CODE XREF: _except_handler3+43j
		mov	eax, 1
		jmp	short loc_402CAA
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_402C95:				; CODE XREF: _except_handler3+18j
		push	ebp
		lea	ebp, [ebx+10h]
		push	0FFFFFFFFh
		push	ebx
...
loc_402CAA:				; CODE XREF: _except_handler3+B9j
...
loc_402CE5:				; CODE XREF: _chkstk+5j
		push	ecx
		lea	ecx, [esp+4+arg_0]

loc_402CEA:				; CODE XREF: _chkstk+2Cj
		sub	ecx, 1000h
		sub	eax, 1000h
		test	[ecx], eax
		cmp	eax, 1000h
		jnb	short loc_402CEA
		sub	ecx, eax
		mov	eax, esp
		test	[ecx], eax
		mov	esp, ecx
...
loc_402D2E:				; CODE XREF: _heap_alloc+Cj
					; _heap_alloc+14j
		test	esi, esi
		jnz	short loc_402D33
		inc	esi

loc_402D33:				; CODE XREF: _heap_alloc+23j
		cmp	__active_heap, 1
		jz	short loc_402D42
		add	esi, 0Fh
		and	esi, 0FFFFFFF0h

loc_402D42:				; CODE XREF: _heap_alloc+2Dj
		push	esi
		push	0
		push	_crtheap
		call	ds:__imp__HeapAlloc@12 ; __declspec(dllimport) HeapAlloc(x,x,x)

loc_402D51:				; CODE XREF: _heap_alloc+1Fj
		pop	esi
		retn
_heap_alloc	endp
...
loc_402D5A:				; CODE XREF: _nh_malloc+27j
		push	[esp+arg_0]
		call	_heap_alloc
		test	eax, eax
		pop	ecx
		jnz	short locret_402D7E
		cmp	[esp+arg_4], eax
		jz	short locret_402D7E
		push	[esp+arg_0]
		call	_callnewh
		test	eax, eax
		pop	ecx
...
loc_402D7C:				; CODE XREF: _nh_malloc+5j
		xor	eax, eax

locret_402D7E:				; CODE XREF: _nh_malloc+13j
					; _nh_malloc+19j
		retn
_nh_malloc	endp
...
loc_402DA0:				; CODE XREF: _isatty+Aj
		mov	ecx, eax
		sar	ecx, 5
...
arg_0		= dword	ptr  0Ch
		...
		mov	eax, [esi+0Ch]
		test	al, al
		jns	short loc_402E06
		and	eax, 0FFFFFFFDh
		mov	[esi+0Ch], eax
		jmp	short loc_402E06
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_402DFF:				; CODE XREF: _flush+36j
		or	dword ptr [esi+0Ch], 20h
		or	ebx, 0FFFFFFFFh

loc_402E06:				; CODE XREF: _flush+25j _flush+3Dj ...
		pop	edi

loc_402E07:				; CODE XREF: _flush+13j _flush+19j
		mov	eax, [esi+8]
...
loc_402E27:				; CODE XREF: fflush+7j
		push	esi
		call	_flush
		test	eax, eax
		pop	ecx
...
loc_402E37:				; CODE XREF: fflush+1Bj
...
loc_402E4C:				; CODE XREF: fflush+26j
		xor	eax, eax
		pop	esi
		retn
fflush		endp
...
arg_0		= dword	ptr  10h
		...
		xor	edi, edi
		cmp	_nstream, esi
		jle	short loc_402EAE

loc_402E61:				; CODE XREF: flsall+5Cj
		mov	eax, __piob
		mov	eax, [eax+esi*4]
		test	eax, eax
		jz	short loc_402EA5
...
loc_402E8B:				; CODE XREF: flsall+2Aj
		cmp	[esp+arg_0], 0
		jnz	short loc_402EA5
		test	cl, 2
		jz	short loc_402EA5
		push	eax
		call	fflush
...
loc_402EA5:				; CODE XREF: flsall+1Bj flsall+23j ...
		inc	esi
		cmp	esi, _nstream
		jl	short loc_402E61

loc_402EAE:				; CODE XREF: flsall+Fj
		cmp	[esp+arg_0], 1
		mov	eax, ebx
		jz	short loc_402EB9
		mov	eax, edi

loc_402EB9:				; CODE XREF: flsall+65j
		pop	edi
		pop	esi
		pop	ebx
		retn
...
loc_402EFF:				; CODE XREF: _flsbuf+20j
		mov	eax, [esi+0Ch]
		and	dword ptr [esi+4], 0
		and	[ebp+arg_4], 0
		and	eax, 0FFFFFFEFh
		...
		test	ax, 10Ch
		mov	[esi+0Ch], eax
		jnz	short loc_402F3B
		cmp	esi, offset dword_40CB80
		jz	short loc_402F29
		cmp	esi, offset dword_40CBA0
		jnz	short loc_402F34

loc_402F29:				; CODE XREF: _flsbuf+59j
		push	ebx
		call	_isatty
		test	eax, eax
		pop	ecx
...
loc_402F34:				; CODE XREF: _flsbuf+61j
		push	esi
		call	_getbuf
		pop	ecx

loc_402F3B:				; CODE XREF: _flsbuf+51j _flsbuf+6Cj
...
loc_402F68:				; CODE XREF: _flsbuf+93j
		cmp	ebx, 0FFFFFFFFh
		jz	short loc_402F83
		mov	eax, ebx
		sar	eax, 5
...
loc_402F83:				; CODE XREF: _flsbuf+A5j
		mov	eax, offset __badioinfo

loc_402F88:				; CODE XREF: _flsbuf+BBj
...
loc_402F98:				; CODE XREF: _flsbuf+A0j
		add	esp, 0Ch

loc_402F9B:				; CODE XREF: _flsbuf+C6j
		mov	eax, [esi+8]
...
loc_402FA5:				; CODE XREF: _flsbuf+7Cj
		xor	edi, edi
		inc	edi
		push	edi
		lea	eax, [ebp+arg_0]
...
loc_402FB9:				; CODE XREF: _flsbuf+DDj
		cmp	[ebp+arg_4], edi
		pop	edi
		jz	short loc_402FC5
		or	dword ptr [esi+0Ch], 20h
		jmp	short loc_402FD5
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_402FC5:				; CODE XREF: _flsbuf+F7j
		mov	eax, [ebp+arg_0]
		and	eax, 0FFh
		jmp	short loc_402FD8
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_402FCF:				; CODE XREF: _flsbuf+10j _flsbuf+18j ...
		or	eax, 20h
		mov	[esi+0Ch], eax

loc_402FD5:				; CODE XREF: _flsbuf+FDj
		or	eax, 0FFFFFFFFh

loc_402FD8:				; CODE XREF: _flsbuf+107j
		pop	esi
		pop	ebx
		pop	ebp
		retn
...
loc_403004:				; CODE XREF: free+11j free+1Cj
		push	0
		push	_crtheap
		call	ds:__imp__HeapFree@12 ;	__declspec(dllimport) HeapFree(x,x,x)

loc_403012:				; CODE XREF: free+7j
		pop	esi
		retn
free		endp
...
loc_403025:				; CODE XREF: wctomb+Bj
...
loc_40303F:				; CODE XREF: wctomb+17j
		lea	ecx, [ebp+arg_0]
		push	ecx
		push	esi
		push	__mb_cur_max
...
loc_40306A:				; CODE XREF: wctomb+22j wctomb+4Fj
		mov	errno, 2Ah
		or	eax, 0FFFFFFFFh

loc_403077:				; CODE XREF: wctomb+Fj	wctomb+29j ...
		pop	esi
		pop	ebp
		retn
wctomb		endp
...
report_failure	proc near		; CODE XREF: __security_check_cookie:loc_4030C0j
		push	8
...
loc_4030AA:				; CODE XREF: report_failure+1Bj
		or	dword ptr [ebp-4], 0FFFFFFFFh
		push	3
		call	ds:__imp__ExitProcess@4	; __declspec(dllimport)	ExitProcess(x)
		int	3		; Trap to Debugger
...
loc_4030C0:				; CODE XREF: __security_check_cookie+6j
		jmp	report_failure
...
arg_C		= dword	ptr  14h
		...
		mul	[esp+arg_8]
		add	edx, ecx
		jmp	short loc_403148
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_403101:				; CODE XREF: _aulldvrm+7j
		mov	ecx, eax
		mov	ebx, [esp+arg_8]
		mov	edx, [esp+arg_4]
		mov	eax, [esp+arg_0]

loc_40310F:				; CODE XREF: _aulldvrm+49j
		shr	ecx, 1
		rcr	ebx, 1
		shr	edx, 1
		rcr	eax, 1
...
loc_40313D:				; CODE XREF: _aulldvrm+5Dj
					; _aulldvrm+63j
		dec	esi
		sub	eax, [esp+arg_8]
		sbb	edx, [esp+arg_C]

loc_403146:				; CODE XREF: _aulldvrm+65j
					; _aulldvrm+6Bj
		xor	ebx, ebx

loc_403148:				; CODE XREF: _aulldvrm+2Fj
		sub	eax, [esp+arg_0]
		sbb	edx, [esp+arg_4]
		neg	edx
		neg	eax
...
loc_403178:				; CODE XREF: calloc+10j calloc+65j
		xor	edi, edi
		cmp	esi, 0FFFFFFE0h
		ja	short loc_4031B8
		cmp	__active_heap, 3
...
loc_4031A3:				; CODE XREF: calloc+21j calloc+2Fj
		push	esi
		push	8
		push	_crtheap
		call	ds:__imp__HeapAlloc@12 ; __declspec(dllimport) HeapAlloc(x,x,x)
...
loc_4031B8:				; CODE XREF: calloc+18j
		cmp	_newmode, 0
		jz	short loc_4031DA
		push	esi
		call	_callnewh
...
loc_4031CE:				; CODE XREF: calloc+3Cj
		push	ebx
		push	0
		push	edi
		call	memset
...
loc_4031DA:				; CODE XREF: calloc+51j calloc+5Aj
		mov	eax, edi

loc_4031DC:				; CODE XREF: calloc+67j
		pop	edi
		pop	esi
		pop	ebx
		retn
...
loc_4031EF:				; CODE XREF: _fcloseall+51j
		mov	eax, __piob
		mov	eax, [eax+esi*4]
		test	eax, eax
		jz	short loc_40322A
...
loc_40320E:				; CODE XREF: _fcloseall+1Fj
					; _fcloseall+2Bj
		cmp	esi, 14h
		jl	short loc_40322A
		mov	eax, __piob
...
loc_40322A:				; CODE XREF: _fcloseall+19j
					; _fcloseall+31j
		inc	esi
		cmp	esi, _nstream
		jl	short loc_4031EF

loc_403233:				; CODE XREF: _fcloseall+Dj
		mov	eax, edi
		pop	edi
		pop	esi
		retn
...
arg_0		= dword	ptr  8
		...
		add	edx, 4
		cmp	esi, edx
		jnb	short loc_4032AB
		mov	ecx, 800h
		cmp	esi, ecx
		jnb	short loc_403268
		mov	ecx, esi

loc_403268:				; CODE XREF: _onexit+2Cj
		add	ecx, esi
		push	ecx
		push	eax
		call	realloc
...
loc_40328E:				; CODE XREF: _onexit+3Dj _onexit+52j
		mov	ecx, __onexitend
...
loc_4032AB:				; CODE XREF: _onexit+23j
		mov	eax, [esp+arg_0]
		mov	[ecx], eax
		add	__onexitend, 4
		pop	esi
...
loc_4032E4:				; CODE XREF: __onexitinit+12j
		and	dword ptr [eax], 0
		mov	eax, __onexitbegin
		mov	__onexitend, eax
		xor	eax, eax
...
loc_403374:				; CODE XREF: __crtMessageBoxA+11j
...
loc_4033A0:				; CODE XREF: __crtMessageBoxA+8Dj
...
loc_4033AF:				; CODE XREF: __crtMessageBoxA+22j
					; __crtMessageBoxA+3Dj
		xor	eax, eax
		jmp	short loc_4033E8
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4033B3:				; CODE XREF: __crtMessageBoxA+B3j
		or	[ebp+arg_A], 4
		jmp	short loc_4033D8
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4033B9:				; CODE XREF: __crtMessageBoxA+87j
...
loc_4033D8:				; CODE XREF: __crtMessageBoxA+B9j
...
loc_4033E8:				; CODE XREF: __crtMessageBoxA+BDj
		pop	edi
		pop	esi
		pop	ebx
		leave
...
loc_40341C:				; CODE XREF: strncpy+1Fj strncpy+45j
		mov	al, [esi]
		add	esi, 1
		mov	[edi], al
		add	edi, 1
...
loc_40343E:				; CODE XREF: strncpy+ADj
		and	ebx, 3
		jz	short loc_403456

loc_403443:				; CODE XREF: strncpy+2Aj strncpy+64j
		mov	al, [esi]
		add	esi, 1
		mov	[edi], al
		add	edi, 1
...
loc_403456:				; CODE XREF: strncpy+39j strncpy+51j
...
loc_40345E:				; CODE XREF: strncpy+3Dj
		test	edi, 3
		jz	short loc_40347C

loc_403466:				; CODE XREF: strncpy+8Aj
		mov	[edi], al
		add	edi, 1
		sub	ecx, 1
		jz	loc_40350C
		test	edi, 3
		jnz	short loc_403466

loc_40347C:				; CODE XREF: strncpy+74j
		mov	ebx, ecx
		shr	ecx, 2
		jnz	short loc_4034F7

loc_403483:				; CODE XREF: strncpy+9Bj strncpy+116j
		mov	[edi], al
		add	edi, 1

loc_403488:				; CODE XREF: strncpy+5Fj
		sub	ebx, 1
		jnz	short loc_403483
		pop	ebx
		pop	esi

loc_40348F:				; CODE XREF: strncpy+7j
		mov	eax, [esp+4+arg_0]
		pop	edi
		retn
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_403495:				; CODE XREF: strncpy+C7j strncpy+DFj
		mov	[edi], edx
		add	edi, 4
		sub	ecx, 1
		jz	short loc_40343E

loc_40349F:				; CODE XREF: strncpy+24j strncpy+4Cj
		mov	edx, 7EFEFEFFh
		mov	eax, [esi]
		add	edx, eax
		xor	eax, 0FFFFFFFFh
...
loc_4034D5:				; CODE XREF: strncpy+D7j
		and	edx, 0FFFFh
		mov	[edi], edx
		jmp	short loc_4034ED
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4034DF:				; CODE XREF: strncpy+CFj
		and	edx, 0FFh
		mov	[edi], edx
		jmp	short loc_4034ED
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4034E9:				; CODE XREF: strncpy+CBj
		xor	edx, edx
		mov	[edi], edx

loc_4034ED:				; CODE XREF: strncpy+E3j strncpy+EDj ...
		add	edi, 4
		xor	eax, eax
		sub	ecx, 1
		jz	short loc_403503

loc_4034F7:				; CODE XREF: strncpy+91j
		xor	eax, eax

loc_4034F9:				; CODE XREF: strncpy+111j
		mov	[edi], eax
		add	edi, 4
		sub	ecx, 1
		jnz	short loc_4034F9

loc_403503:				; CODE XREF: strncpy+105j
		and	ebx, 3
		jnz	loc_403483

loc_40350C:				; CODE XREF: strncpy+7Ej
		mov	eax, [esp+arg_C]
		pop	ebx
		pop	esi
		pop	edi
...
loc_403530:				; CODE XREF: getSystemCP+Aj
		cmp	eax, 0FFFFFFFDh
		jnz	short loc_403545
		mov	fSystemSet, 1
		jmp	ds:__imp__GetACP@0 ; __declspec(dllimport) GetACP()
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_403545:				; CODE XREF: getSystemCP+1Fj
		cmp	eax, 0FFFFFFFCh
		jnz	short locret_403559
		mov	eax, __lc_codepage
		mov	fSystemSet, 1

locret_403559:				; CODE XREF: getSystemCP+34j
		retn
getSystemCP	endp
...
loc_403571:				; CODE XREF: CPtoLCID+12j
		mov	eax, 404h
		retn
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_403577:				; CODE XREF: CPtoLCID+Fj
		mov	eax, 412h
		retn
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40357D:				; CODE XREF: CPtoLCID+Aj
		mov	eax, 804h
		retn
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_403583:				; CODE XREF: CPtoLCID+5j
		mov	eax, 411h
		retn
CPtoLCID	endp
...
setSBCS		proc near		; CODE XREF: _setmbcp:loc_403906p
		push	edi
		push	40h
		xor	eax, eax
		pop	ecx
...
setSBUpLow	proc near		; CODE XREF: _setmbcp:loc_40390Bp
...
loc_4035E4:				; CODE XREF: setSBUpLow+3Cj
...
loc_403603:				; CODE XREF: setSBUpLow+7Ej
...
loc_40362A:				; CODE XREF: setSBUpLow+59j
		inc	edx
		mov	al, [edx]
		inc	edx
		test	al, al
		jnz	short loc_403603
		pop	edi
		pop	ebx

loc_403634:				; CODE XREF: setSBUpLow+4Aj
		push	0
		push	__mblcid
		lea	eax, [ebp+var_518]
		push	__mbcodepage
...
loc_4036A9:				; CODE XREF: setSBUpLow+139j
...
loc_4036C4:				; CODE XREF: setSBUpLow+12Dj
		mov	_mbcasemap[eax], cl
		jmp	short loc_4036E8
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4036CC:				; CODE XREF: setSBUpLow+102j
		test	cl, 2
		jz	short loc_4036E1
...
loc_4036E1:				; CODE XREF: setSBUpLow+11Dj
		mov	_mbcasemap[eax], 0

loc_4036E8:				; CODE XREF: setSBUpLow+118j
		inc	eax
		cmp	eax, esi
		jb	short loc_4036A9
...
loc_4036EF:				; CODE XREF: setSBUpLow+2Aj
		xor	eax, eax

loc_4036F1:				; CODE XREF: setSBUpLow+17Fj
		cmp	eax, 41h
		jb	short loc_40370F
		cmp	eax, 5Ah
		ja	short loc_40370F
...
loc_403707:				; CODE XREF: setSBUpLow+173j
		mov	_mbcasemap[eax], cl
		jmp	short loc_40372E
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40370F:				; CODE XREF: setSBUpLow+142j
					; setSBUpLow+147j
		cmp	eax, 61h
		jb	short loc_403727
		cmp	eax, 7Ah
...
loc_403727:				; CODE XREF: setSBUpLow+160j
					; setSBUpLow+165j
		mov	_mbcasemap[eax], 0

loc_40372E:				; CODE XREF: setSBUpLow+15Bj
		inc	eax
		cmp	eax, esi
		jb	short loc_4036F1

loc_403733:				; CODE XREF: setSBUpLow+13Bj
		mov	ecx, [ebp+var_4]
		pop	esi
		call	__security_check_cookie
		leave
...
arg_0		= dword	ptr  8
		...
		jmp	short loc_40379C
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_403771:				; CODE XREF: _setmbcp+1Fj
		cmp	esi, 0FFFFFFFDh
...
loc_403788:				; CODE XREF: _setmbcp+36j
		cmp	esi, 0FFFFFFFCh
		jnz	short loc_4037A1
		mov	eax, __lc_codepage
		mov	fSystemSet, 1

loc_40379C:				; CODE XREF: _setmbcp+31j _setmbcp+48j
		mov	[ebp+arg_0], eax
		mov	esi, eax

loc_4037A1:				; CODE XREF: _setmbcp+4Dj
...
loc_4037B9:				; CODE XREF: _setmbcp+8Cj
...
loc_403812:				; CODE XREF: _setmbcp+183j
		mov	dl, [ecx]
		test	dl, dl
		jz	loc_4038C7
...
loc_403828:				; CODE XREF: _setmbcp+81j
		push	40h
		xor	eax, eax
		pop	ecx
		mov	edi, offset _mbctype
...
loc_403844:				; CODE XREF: _setmbcp+143j
		mov	al, [ebx]
		mov	esi, ebx
		jmp	short loc_403873
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40384A:				; CODE XREF: _setmbcp+137j
		mov	dl, [esi+1]
		test	dl, dl
		jz	short loc_403877
		movzx	eax, al
...
loc_403864:				; CODE XREF: _setmbcp+12Fj
		or	byte_40D701[eax], dl
		inc	eax
		cmp	eax, edi
		jbe	short loc_403864

loc_40386F:				; CODE XREF: _setmbcp+11Bj
		inc	esi
		inc	esi
		mov	al, [esi]

loc_403873:				; CODE XREF: _setmbcp+10Aj
		test	al, al
		jnz	short loc_40384A

loc_403877:				; CODE XREF: _setmbcp+111j
		inc	[ebp+var_1C]
		add	ebx, 8
		cmp	[ebp+var_1C], 4
		jb	short loc_403844
...
loc_4038AF:				; CODE XREF: _setmbcp+17Bj
		or	byte_40D701[eax], 4
		inc	eax

loc_4038B7:				; CODE XREF: _setmbcp+E5j
		cmp	eax, edx
...
loc_4038C7:				; CODE XREF: _setmbcp+CBj _setmbcp+D8j
		mov	eax, edi

loc_4038C9:				; CODE XREF: _setmbcp+198j
...
loc_4038EC:				; CODE XREF: _setmbcp+C1j
		mov	__ismbcodepage,	ebx

loc_4038F2:				; CODE XREF: _setmbcp+1ACj
		xor	eax, eax
		mov	edi, offset __mbulinfo
		stosd
		stosd
...
loc_4038FE:				; CODE XREF: _setmbcp+9Cj
		cmp	fSystemSet, ebx
		jz	short loc_403914

loc_403906:				; CODE XREF: _setmbcp+71j
		call	setSBCS

loc_40390B:				; CODE XREF: _setmbcp+16Fj
					; _setmbcp+1BEj
		call	setSBUpLow

loc_403910:				; CODE XREF: _setmbcp+69j
		xor	eax, eax
		jmp	short loc_403917
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_403914:				; CODE XREF: _setmbcp+1C6j
		or	eax, 0FFFFFFFFh

loc_403917:				; CODE XREF: _setmbcp+1D4j
		mov	ecx, [ebp+var_4]
		pop	edi
		pop	esi
		pop	ebx
...
loc_40394F:				; CODE XREF: __initmbctable+7j
		xor	eax, eax
		retn
__initmbctable	endp
...
memcpy:					; CODE XREF: __crtGetEnvironmentStringsA+10Ap
		...
		add	eax, esi
		cmp	edi, esi
		jbe	short loc_403980
		cmp	edi, eax
		jb	loc_403AFC

loc_403980:				; CODE XREF: .text:00403976j
		test	edi, 3
		jnz	short loc_40399C
		shr	ecx, 2
		and	edx, 3
		cmp	ecx, 8
		jb	short near ptr dword_4039BC
		rep movsd
		jmp	ds:off_403AAC[edx*4]
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40399C:				; CODE XREF: .text:00403986j
		mov	eax, edi
		mov	edx, 3
		sub	ecx, 4
		jb	short loc_4039B4
		and	eax, 3
		add	ecx, eax
		jmp	ds:dword_4039C0[eax*4]
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4039B4:				; CODE XREF: .text:004039A6j
		jmp	dword ptr ds:loc_403ABC[ecx*4]
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
		align 4
dword_4039BC	dd 408D24FFh		; CODE XREF: .text:00403991j
dword_4039C0	dd 9000403Ah		; DATA XREF: .text:004039ADr

; ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ S U B	R O U T	I N E ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ


sub_4039C4	proc near
		sar	byte ptr [ecx],	1
		inc	eax
		add	ah, bh
		cmp	[eax+0], eax
		...
		add	al, cl
		jmp	near ptr 287C1E7h
sub_4039C4	endp

; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
		dd 8303C683h, 0F98303C7h, 0F3CC7208h, 9524FFA5h, 403AACh
		dd 2300498Dh, 88068AD1h, 1468A07h, 8802E9C1h, 0C6830147h
		dd 2C78302h, 7208F983h,	0FFA5F3A6h, 3AAC9524h, 23900040h
		dd 88068AD1h, 1C68307h,	8302E9C1h, 0F98301C7h, 0F3887208h
		dd 9524FFA5h, 403AACh
		align 10h
...
sub_403A40	proc near
		mov	ds:9000403Ah, eax
		cmp	al, [eax+0]
		mov	[edx], bh
		inc	eax
		add	[eax+7800403Ah], al
		cmp	al, [eax+0]
		jo	short loc_403A90
		inc	eax
		add	[eax+3Ah], ch
...
loc_403A90:				; CODE XREF: sub_403A40+14j
		mov	eax, [esi+ecx*4-4]
		mov	[edi+ecx*4-4], eax
		lea	eax, ds:0[ecx*4]
		add	esi, eax
...
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
		align 4
off_403AAC	dd offset loc_403ABC	; DATA XREF: .text:00403995r
					; sub_403A40+63r
		dd offset loc_403AC4
		dd offset loc_403AD0
		dd offset loc_403AE4
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_403ABC:				; CODE XREF: .text:00403995j
					; sub_403A40+63j
					; DATA XREF: ...
		mov	eax, [ebp+8]
		pop	esi
...
loc_403AC4:				; CODE XREF: sub_403A40+63j
					; DATA XREF: sub_403A40+70o
		mov	al, [esi]
		mov	[edi], al
		mov	eax, [ebp+8]
		pop	esi
...
loc_403AD0:				; CODE XREF: sub_403A40+63j
					; DATA XREF: sub_403A40+74o
		mov	al, [esi]
		mov	[edi], al
		mov	al, [esi+1]
		mov	[edi+1], al
...
loc_403AE4:				; CODE XREF: sub_403A40+63j
					; DATA XREF: sub_403A40+78o
		mov	al, [esi]
		mov	[edi], al
		mov	al, [esi+1]
		mov	[edi+1], al
		...
		leave
		retn
sub_403A40	endp ; sp =  4

; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
		align 4

loc_403AFC:				; CODE XREF: .text:0040397Aj
		lea	esi, [ecx+esi-4]
		lea	edi, [ecx+edi-4]
		test	edi, 3
		...
		rep movsd
		cld
		jmp	dword ptr ds:sub_403C48[edx*4]
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
		align 4

loc_403B24:				; CODE XREF: .text:00403B15j
					; .text:00403B70j ...
		neg	ecx
		jmp	dword ptr ds:loc_403BF7+1[ecx*4]
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
		align 10h

loc_403B30:				; CODE XREF: .text:00403B0Aj
		mov	eax, edi
		mov	edx, 3
		cmp	ecx, 4
		jb	short near ptr dword_403B48
		and	eax, 3
		sub	ecx, eax
		jmp	ds:dword_403B4C[eax*4]
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
dword_403B48	dd 488D24FFh		; CODE XREF: .text:00403B3Aj
dword_403B4C	dd 9000403Ch		; DATA XREF: .text:00403B41r

; ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ S U B	R O U T	I N E ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ


sub_403B50	proc near
		pop	esp
		cmp	eax, [eax+0]
		cmp	byte ptr [ebx],	40h
		add	[eax-75FFBFC5h], ch
		inc	esi
		add	esp, [ebx]
		ror	dword ptr [eax-117CFCB9h], 1
		add	ecx, eax
		jmp	near ptr 22FBE6Fh
sub_403B50	endp
...
loc_403BF7:				; DATA XREF: .text:00403B26r
		add	[edi], bh
		cmp	al, 40h
...
sub_403C48	proc near		; DATA XREF: .text:00403B1Br
					; .text:00403B76r ...

arg_458B0040	= byte ptr  458B0044h
		...
		add	[eax+3Ch], dh
		inc	eax
		add	[esp+edi-4+arg_458B0040], al
		or	[esi+5Fh], bl
		leave
		retn
sub_403C48	endp ; sp =  4
...
loc_403CCF:				; CODE XREF: __sbh_heap_init+1Aj
		mov	ecx, [esp+arg_0]
...
arg_0		= dword	ptr  4
		...
		lea	ecx, [eax+ecx*4]
		jmp	short loc_403D1E
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_403D0C:				; CODE XREF: __sbh_find_block+26j
		mov	edx, [esp+arg_0]
		sub	edx, [eax+0Ch]
		cmp	edx, 100000h
		jb	short locret_403D24
		add	eax, 14h

loc_403D1E:				; CODE XREF: __sbh_find_block+10j
		cmp	eax, ecx
		jb	short loc_403D0C
		xor	eax, eax

locret_403D24:				; CODE XREF: __sbh_find_block+1Fj
		retn
...
arg_4		= dword	ptr  0Ch
		...
		dec	edx
		cmp	edx, 3Fh
		jbe	short loc_403D88
		push	3Fh
		pop	edx

loc_403D88:				; CODE XREF: __sbh_free_block+5Ej
		mov	ecx, [ebx+4]
		cmp	ecx, [ebx+8]
		jnz	short loc_403DD2
		cmp	edx, 20h
		mov	ebx, 80000000h
		jnb	short loc_403DB3
		mov	ecx, edx
		shr	ebx, cl
		lea	ecx, [edx+eax+4]
		not	ebx
...
loc_403DB3:				; CODE XREF: __sbh_free_block+73j
		lea	ecx, [edx-20h]
		shr	ebx, cl
		lea	ecx, [edx+eax+4]
		not	ebx
...
loc_403DCF:				; CODE XREF: __sbh_free_block+85j
					; __sbh_free_block+8Cj	...
		mov	ebx, [ebp+arg_4]

loc_403DD2:				; CODE XREF: __sbh_free_block+69j
		mov	edx, [ebx+8]
		mov	ebx, [ebx+4]
		mov	ecx, [ebp+var_4]
		add	ecx, [ebp+var_C]
...
loc_403DF0:				; CODE XREF: __sbh_free_block+55j
		mov	edx, ecx
		sar	edx, 4
		dec	edx
		cmp	edx, 3Fh
		jbe	short loc_403DFE
		push	3Fh
		pop	edx

loc_403DFE:				; CODE XREF: __sbh_free_block+D4j
		mov	ebx, [ebp+var_8]
		and	ebx, 1
		mov	[ebp+var_C], ebx
		jnz	loc_403E9C
		...
		pop	esi
		cmp	ebx, esi
		jbe	short loc_403E23
		mov	ebx, esi

loc_403E23:				; CODE XREF: __sbh_free_block+FAj
		add	ecx, [ebp+var_8]
		mov	edx, ecx
		sar	edx, 4
		dec	edx
		cmp	edx, esi
		mov	[ebp+var_4], ecx
		jbe	short loc_403E35
		mov	edx, esi

loc_403E35:				; CODE XREF: __sbh_free_block+10Cj
		cmp	ebx, edx
		jz	short loc_403E97
		mov	ecx, [ebp+arg_4]
		mov	esi, [ecx+4]
...
loc_403E65:				; CODE XREF: __sbh_free_block+127j
		lea	ecx, [ebx-20h]
		shr	esi, cl
		not	esi
...
loc_403E7F:				; CODE XREF: __sbh_free_block+11Dj
...
loc_403E97:				; CODE XREF: __sbh_free_block+112j
		mov	esi, [ebp+arg_4]
		jmp	short loc_403E9F
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_403E9C:				; CODE XREF: __sbh_free_block+E2j
		mov	ebx, [ebp+arg_0]

loc_403E9F:				; CODE XREF: __sbh_free_block+175j
		cmp	[ebp+var_C], 0
		jnz	short loc_403EAD
		cmp	ebx, edx
		jz	loc_403F2D

loc_403EAD:				; CODE XREF: __sbh_free_block+17Ej
		mov	ecx, [ebp+var_10]
		lea	ecx, [ecx+edx*8]
		mov	ebx, [ecx+4]
		mov	[esi+8], ecx
...
loc_403EF3:				; CODE XREF: __sbh_free_block+1BEj
		mov	ebx, 80000000h
		mov	ecx, edx
		shr	ebx, cl
...
loc_403F04:				; CODE XREF: __sbh_free_block+1B8j
		cmp	byte ptr [ebp+arg_4+3],	0
...
loc_403F1A:				; CODE XREF: __sbh_free_block+1E3j
		lea	ecx, [edx-20h]
		mov	edx, 80000000h
		shr	edx, cl
...
loc_403F2D:				; CODE XREF: __sbh_free_block+182j
		...
		jnz	short loc_403FBB
		and	dword ptr [eax+4], 0FFFFFFFEh
		mov	eax, __sbh_pHeaderDefer

loc_403FBB:				; CODE XREF: __sbh_free_block+28Bj
		...
		jbe	short loc_404020
		sub	[ebp+arg_0], 14h

loc_404020:				; CODE XREF: __sbh_free_block+2F5j
		mov	eax, __sbh_pHeaderList
		mov	__sbh_pHeaderScan, eax

loc_40402A:				; CODE XREF: __sbh_free_block+223j
					; __sbh_free_block+29Aj
		mov	eax, [ebp+arg_0]
		mov	__sbh_pHeaderDefer, eax
		mov	__sbh_indGroupDefer, edi

loc_404038:				; CODE XREF: __sbh_free_block+216j
		pop	ebx

loc_404039:				; CODE XREF: __sbh_free_block+37j
		pop	edi
		pop	esi
		leave
		retn
...
loc_404072:				; CODE XREF: __sbh_alloc_new_region+2Fj
		add	__sbh_sizeHeaderList, 10h
		mov	__sbh_pHeaderList, eax
		mov	eax, __sbh_cntHeaderList

loc_404083:				; CODE XREF: __sbh_alloc_new_region+10j
...
loc_4040AA:				; CODE XREF: __sbh_alloc_new_region+9Bj
		xor	eax, eax
		jmp	short loc_4040F1
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4040AE:				; CODE XREF: __sbh_alloc_new_region+6Bj
		push	4
		push	2000h
		push	100000h
		push	edi
...
loc_4040DA:				; CODE XREF: __sbh_alloc_new_region+89j
...
loc_4040F1:				; CODE XREF: __sbh_alloc_new_region+6Fj
		pop	esi
		pop	edi
		retn
...
arg_0		= dword	ptr  8
		...
		push	edi
		xor	ebx, ebx
		jmp	short loc_40410C
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_404109:				; CODE XREF: __sbh_alloc_new_group+1Aj
		shl	eax, 1
		inc	ebx

loc_40410C:				; CODE XREF: __sbh_alloc_new_group+13j
		test	eax, eax
		jge	short loc_404109
		mov	eax, ebx
		imul	eax, 204h
...
loc_404125:				; CODE XREF: __sbh_alloc_new_group+3Bj
		mov	[eax+8], eax
		mov	[eax+4], eax
		add	eax, 8
		dec	edx
		jnz	short loc_404125
		push	4
		mov	edi, ebx
		push	1000h
		shl	edi, 0Fh
...
loc_404158:				; CODE XREF: __sbh_alloc_new_group+5Aj
		lea	edx, [edi+7000h]
		cmp	edi, edx
		mov	[ebp+var_4], edx
		ja	short loc_4041A8
...
loc_404170:				; CODE XREF: __sbh_alloc_new_group+AFj
...
loc_4041A8:				; CODE XREF: __sbh_alloc_new_group+6Fj
		mov	eax, [ebp+var_8]
		add	eax, 1F8h
		lea	ecx, [edi+0Ch]
		mov	[eax+4], ecx
...
loc_4041E5:				; CODE XREF: __sbh_alloc_new_group+ECj
		mov	edx, 80000000h
		mov	ecx, ebx
		shr	edx, cl
		not	edx
...
loc_4041F5:				; CODE XREF: __sbh_alloc_new_group+5Fj
		pop	edi
		pop	esi
		pop	ebx
		leave
...
arg_8		= dword	ptr  10h
		...
		cmp	ecx, 3Fh
		mov	[ebp+var_8], ecx
		jbe	short loc_40426F
		push	3Fh
		pop	ecx
		mov	[ebp+var_8], ecx

loc_40426F:				; CODE XREF: __sbh_resize_block+6Dj
		mov	ebx, [edi+4]
		cmp	ebx, [edi+8]
		jnz	short loc_4042BA
		cmp	ecx, 20h
		mov	ebx, 80000000h
		jnb	short loc_40429B
		shr	ebx, cl
		mov	ecx, [ebp+var_8]
		lea	ecx, [ecx+eax+4]
		not	ebx
		...
		mov	ecx, [ebp+arg_0]
		and	[ecx], ebx
		jmp	short loc_4042BA
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40429B:				; CODE XREF: __sbh_resize_block+85j
		add	ecx, 0FFFFFFE0h
		shr	ebx, cl
		mov	ecx, [ebp+var_8]
		lea	ecx, [ecx+eax+4]
...
loc_4042BA:				; CODE XREF: __sbh_resize_block+7Bj
		...
		cmp	edi, 3Fh
		lea	ecx, [ecx+esi-4]
		jbe	short loc_4042F4
		push	3Fh
		pop	edi

loc_4042F4:				; CODE XREF: __sbh_resize_block+F5j
		mov	ebx, [ebp+var_C]
		lea	ebx, [ebx+edi*8]
		mov	[ebp+arg_8], ebx
		mov	ebx, [ebx+4]
...
loc_404340:				; CODE XREF: __sbh_resize_block+136j
		lea	eax, [eax+edx*4+44h]
		mov	ecx, edi
		jmp	short loc_404368
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_404348:				; CODE XREF: __sbh_resize_block+130j
		cmp	byte ptr [ebp+arg_8+3],	0
...
loc_40435E:				; CODE XREF: __sbh_resize_block+152j
		lea	eax, [eax+edx*4+0C4h]
		lea	ecx, [edi-20h]

loc_404368:				; CODE XREF: __sbh_resize_block+14Cj
		mov	edx, 80000000h
		shr	edx, cl
		or	[eax], edx

loc_404371:				; CODE XREF: __sbh_resize_block+11Ej
		mov	edx, [ebp+arg_4]
		mov	ecx, [ebp+var_4]
		lea	eax, [edx+esi-4]
		mov	[eax], ecx
...
loc_404383:				; CODE XREF: __sbh_resize_block+DEj
		mov	edx, [ebp+arg_4]

loc_404386:				; CODE XREF: __sbh_resize_block+187j
		lea	eax, [esi+1]
		mov	[edx-4], eax
		mov	[edx+esi-8], eax
		jmp	loc_4044D1
...
loc_404395:				; CODE XREF: __sbh_resize_block+50j
					; __sbh_resize_block+5Aj
		xor	eax, eax
		jmp	loc_4044D4
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40439C:				; CODE XREF: __sbh_resize_block+47j
		jge	loc_4044D1
		mov	ebx, [ebp+arg_4]
		sub	[ebp+arg_8], esi
		lea	ecx, [esi+1]
...
loc_4043C7:				; CODE XREF: __sbh_resize_block+1C8j
		...
		dec	esi
		cmp	esi, 3Fh
		jbe	short loc_4043E0
		push	3Fh
		pop	esi

loc_4043E0:				; CODE XREF: __sbh_resize_block+1E1j
		mov	ecx, [edi+4]
		cmp	ecx, [edi+8]
		jnz	short loc_40442A
		cmp	esi, 20h
		mov	ebx, 80000000h
		jnb	short loc_40440B
		mov	ecx, esi
		shr	ebx, cl
		lea	esi, [esi+eax+4]
		not	ebx
		...
		mov	ecx, [ebp+arg_0]
		and	[ecx], ebx
		jmp	short loc_404427
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40440B:				; CODE XREF: __sbh_resize_block+1F6j
		lea	ecx, [esi-20h]
		shr	ebx, cl
		lea	ecx, [esi+eax+4]
		not	ebx
...
loc_404427:				; CODE XREF: __sbh_resize_block+208j
					; __sbh_resize_block+20Fj ...
		mov	ebx, [ebp+arg_4]

loc_40442A:				; CODE XREF: __sbh_resize_block+1ECj
		mov	ecx, [edi+8]
		mov	esi, [edi+4]
		mov	[ecx+4], esi
		mov	esi, [edi+8]
		...
		dec	esi
		cmp	esi, 3Fh
		jbe	short loc_404451
		push	3Fh
		pop	esi

loc_404451:				; CODE XREF: __sbh_resize_block+1D1j
		...
		cmp	esi, 20h
		mov	[esi+eax+4], cl
		jnb	short loc_40449F
		cmp	byte ptr [ebp+arg_4+3],	0
		jnz	short loc_404497
		mov	ecx, esi
		mov	edi, 80000000h
		shr	edi, cl
		mov	ecx, [ebp+arg_0]
...
loc_404497:				; CODE XREF: __sbh_resize_block+28Dj
		lea	eax, [eax+edx*4+44h]
		mov	ecx, esi
		jmp	short loc_4044BF
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40449F:				; CODE XREF: __sbh_resize_block+287j
		cmp	byte ptr [ebp+arg_4+3],	0
...
loc_4044B5:				; CODE XREF: __sbh_resize_block+2A9j
		lea	eax, [eax+edx*4+0C4h]
		lea	ecx, [esi-20h]

loc_4044BF:				; CODE XREF: __sbh_resize_block+2A3j
		mov	edx, 80000000h
		shr	edx, cl
		or	[eax], edx

loc_4044C8:				; CODE XREF: __sbh_resize_block+275j
		mov	eax, [ebp+arg_8]
		mov	[ebx], eax
		mov	[eax+ebx-4], eax

loc_4044D1:				; CODE XREF: __sbh_resize_block+196j
					; __sbh_resize_block:loc_40439Cj
		xor	eax, eax
		inc	eax

loc_4044D4:				; CODE XREF: __sbh_resize_block+19Dj
		pop	edi
		pop	esi
		pop	ebx
		leave
...
loc_404550:				; CODE XREF: __sbh_heapmin+6Cj
		cmp	dword ptr [eax+8], 0FFFFFFFFh
		jnz	short loc_4045A2
		cmp	__sbh_cntHeaderList, 1
		jle	short loc_4045A2
		push	dword ptr [eax+10h]
		push	0
		push	_crtheap
		call	ds:__imp__HeapFree@12 ;	__declspec(dllimport) HeapFree(x,x,x)
...
loc_4045A2:				; CODE XREF: __sbh_heapmin+7Bj
					; __sbh_heapmin+84j
		and	__sbh_pHeaderDefer, 0

locret_4045A9:				; CODE XREF: __sbh_heapmin+7j
		retn
__sbh_heapmin	endp
...
loc_4045D4:				; CODE XREF: __sbh_heap_check+23j
		push	ebx
...
loc_4045ED:				; CODE XREF: __sbh_heap_check+2D4j
		xor	eax, eax

loc_4045EF:				; CODE XREF: __sbh_heap_check+2DCj
		pop	edi
		pop	esi
		pop	ebx
		leave
...
loc_4045F4:				; CODE XREF: __sbh_heap_check+2CEj
		xor	edi, edi

loc_4045F6:				; CODE XREF: __sbh_heap_check+41j
		mov	esi, [ebx+10h]
		push	41C4h
		push	esi
		call	ds:__imp__IsBadWritePtr@8 ; __declspec(dllimport) IsBadWritePtr(x,x)
		...
		mov	[ebp+var_C], edi
		mov	[ebp+var_38], esi
		jmp	short loc_404638
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_404636:				; CODE XREF: __sbh_heap_check+2A7j
		xor	edi, edi

loc_404638:				; CODE XREF: __sbh_heap_check+8Aj
		mov	[ebp+var_28], edi
		mov	[ebp+var_18], edi
		mov	[ebp+var_4], edi
		push	40h
...
loc_404678:				; CODE XREF: __sbh_heap_check+15Cj
...
loc_404694:				; CODE XREF: __sbh_heap_check+14Aj
		mov	ecx, [esi]
		test	cl, 1
		mov	edi, ecx
		jz	short loc_4046AF
		...
		jg	loc_40488F
		inc	[ebp+var_4]
		jmp	short loc_4046C6
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4046AF:				; CODE XREF: __sbh_heap_check+F1j
		mov	eax, ecx
		sar	eax, 4
		dec	eax
		cmp	eax, 3Fh
		jle	short loc_4046BD
		push	3Fh
		pop	eax

loc_4046BD:				; CODE XREF: __sbh_heap_check+10Ej
		lea	eax, [ebp+eax*4+var_138]
		inc	dword ptr [eax]

loc_4046C6:				; CODE XREF: __sbh_heap_check+103j
		cmp	ecx, 10h
		jl	loc_404897
		test	cl, 0Fh
		jnz	loc_404897
...
loc_40471C:				; CODE XREF: __sbh_heap_check+266j
		and	[ebp+var_4], 0
		lea	ebx, [edi+8]
		mov	eax, [ebx-4]
		cmp	eax, edi
...
loc_404734:				; CODE XREF: __sbh_heap_check+20Fj
		mov	ecx, [ebp+var_4]
...
loc_404772:				; CODE XREF: __sbh_heap_check+1D8j
		cmp	ecx, eax
		jz	short loc_404784
		mov	ebx, [ecx]
		and	ebx, 0FFFFFFFEh
		...
		cmp	ecx, edx
		mov	ebx, [ebp+var_30]
		jnz	short loc_404772

loc_404784:				; CODE XREF: __sbh_heap_check+1CAj
		cmp	ecx, edx
		jz	loc_4048A3
		mov	ecx, [eax]
		sar	ecx, 4
		dec	ecx
		cmp	ecx, 3Fh
		jle	short loc_40479A
		push	3Fh
		pop	ecx

loc_40479A:				; CODE XREF: __sbh_heap_check+1EBj
		cmp	ecx, esi
		jnz	loc_4048A7
		mov	ecx, [ebp+var_2C]
		cmp	[eax+8], ecx
...
loc_4047BF:				; CODE XREF: __sbh_heap_check+194j
		cmp	[ebp+var_4], 0
		jz	short loc_4047E6
		cmp	esi, 20h
		mov	eax, 80000000h
		jge	short loc_4047DB
		mov	ecx, esi
		shr	eax, cl
		or	[ebp+var_28], eax
		or	[ebp+var_10], eax
		jmp	short loc_4047E6
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4047DB:				; CODE XREF: __sbh_heap_check+223j
		lea	ecx, [esi-20h]
		shr	eax, cl
		or	[ebp+var_18], eax
		or	[ebp+var_14], eax

loc_4047E6:				; CODE XREF: __sbh_heap_check+184j
...
loc_40481C:				; CODE XREF: __sbh_heap_check+A7j
		mov	eax, [ebp+var_28]
		cmp	eax, [esi-80h]
		jnz	loc_4048BB
		mov	eax, [ebp+var_18]
...
loc_404883:				; CODE XREF: __sbh_heap_check+5Dj
		push	0FFFFFFFEh

loc_404885:				; CODE XREF: __sbh_heap_check+2E3j
					; __sbh_heap_check+2E7j ...
		pop	eax
		jmp	loc_4045EF
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40488B:				; CODE XREF: __sbh_heap_check+BDj
		push	0FFFFFFFCh
		jmp	short loc_404885
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40488F:				; CODE XREF: __sbh_heap_check+FAj
		push	0FFFFFFFAh
		jmp	short loc_404885
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_404893:				; CODE XREF: __sbh_heap_check+140j
					; __sbh_heap_check+14Cj
		push	0FFFFFFF8h
		jmp	short loc_404885
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_404897:				; CODE XREF: __sbh_heap_check+11Fj
					; __sbh_heap_check+128j ...
		push	0FFFFFFF9h
		jmp	short loc_404885
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40489B:				; CODE XREF: __sbh_heap_check+DBj
					; __sbh_heap_check+E4j
		push	0FFFFFFFBh
		jmp	short loc_404885
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40489F:				; CODE XREF: __sbh_heap_check+16Aj
		push	0FFFFFFF7h
		jmp	short loc_404885
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4048A3:				; CODE XREF: __sbh_heap_check+1C2j
					; __sbh_heap_check+1DCj
		push	0FFFFFFF5h
		jmp	short loc_404885
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4048A7:				; CODE XREF: __sbh_heap_check+1F2j
		push	0FFFFFFF4h
		jmp	short loc_404885
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4048AB:				; CODE XREF: __sbh_heap_check+1FEj
		push	0FFFFFFF3h
		jmp	short loc_404885
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4048AF:				; CODE XREF: __sbh_heap_check+19Bj
					; __sbh_heap_check+1A9j
		push	0FFFFFFF6h
		jmp	short loc_404885
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4048B3:				; CODE XREF: __sbh_heap_check+25Aj
		push	0FFFFFFF1h
		jmp	short loc_404885
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4048B7:				; CODE XREF: __sbh_heap_check+242j
					; __sbh_heap_check+252j
		push	0FFFFFFF2h
		jmp	short loc_404885
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4048BB:				; CODE XREF: __sbh_heap_check+278j
					; __sbh_heap_check+283j
		push	0FFFFFFF0h
		jmp	short loc_404885
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4048BF:				; CODE XREF: __sbh_heap_check+2B2j
...
loc_4048E1:				; CODE XREF: _set_sbh_threshold+13j
		xor	eax, eax
		retn
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4048E4:				; CODE XREF: _set_sbh_threshold+8j
		cmp	eax, 1
		push	esi
...
loc_40491A:				; CODE XREF: _set_sbh_threshold+25j
...
loc_40495B:				; CODE XREF: __sbh_alloc_block+30j
		add	ecx, 0FFFFFFE0h
		or	eax, 0FFFFFFFFh
		xor	esi, esi
		shr	eax, cl
...
loc_404968:				; CODE XREF: __sbh_alloc_block+3Bj
		mov	eax, __sbh_pHeaderScan
		mov	ebx, eax
		mov	[ebp+var_C], esi
		cmp	ebx, edi
		jmp	short loc_40498A
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_404976:				; CODE XREF: __sbh_alloc_block+6Fj
		mov	ecx, [ebx+4]
		mov	edi, [ebx]
		and	ecx, [ebp+var_8]
		and	edi, esi
...
loc_40498A:				; CODE XREF: __sbh_alloc_block+56j
		mov	[ebp+arg_0], ebx
		jb	short loc_404976

loc_40498F:				; CODE XREF: __sbh_alloc_block+64j
		cmp	ebx, [ebp+var_4]
		jnz	short loc_4049B8
		mov	ebx, edx
		jmp	short loc_4049A9
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_404998:				; CODE XREF: __sbh_alloc_block+90j
		mov	ecx, [ebx+4]
		mov	edi, [ebx]
		and	ecx, [ebp+var_8]
		and	edi, esi
...
loc_4049A9:				; CODE XREF: __sbh_alloc_block+78j
		cmp	ebx, eax
		mov	[ebp+arg_0], ebx
		jb	short loc_404998

loc_4049B0:				; CODE XREF: __sbh_alloc_block+86j
		cmp	ebx, eax
		jz	loc_404A4C

loc_4049B8:				; CODE XREF: __sbh_alloc_block+74j
...
loc_4049DF:				; CODE XREF: __sbh_alloc_block+ABj
		mov	edx, [eax+0C4h]
		and	edx, [ebp+var_8]
		and	[ebp+var_4], 0
		lea	ecx, [eax+44h]
...
loc_4049FB:				; CODE XREF: __sbh_alloc_block+F2j
		mov	edx, [ecx+84h]
		and	edx, [ebp+var_8]
		inc	[ebp+var_4]
		add	ecx, 4
...
loc_404A12:				; CODE XREF: __sbh_alloc_block+DBj
		mov	edx, [ebp+var_4]

loc_404A15:				; CODE XREF: __sbh_alloc_block+BFj
		mov	ecx, edx
		imul	ecx, 204h
		lea	ecx, [ecx+eax+144h]
		mov	[ebp+var_C], ecx
		...
		push	20h
		pop	edi
		jmp	short loc_404A9E
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_404A40:				; CODE XREF: __sbh_alloc_block+131j
		cmp	dword ptr [ebx+8], 0
		jnz	short loc_404A51
		add	ebx, 14h
		mov	[ebp+arg_0], ebx

loc_404A4C:				; CODE XREF: __sbh_alloc_block+94j
		cmp	ebx, [ebp+var_4]
		jb	short loc_404A40

loc_404A51:				; CODE XREF: __sbh_alloc_block+126j
		cmp	ebx, [ebp+var_4]
...
loc_404A5A:				; CODE XREF: __sbh_alloc_block+14Aj
		cmp	dword ptr [ebx+8], 0
		jnz	short loc_404A6A
		add	ebx, 14h

loc_404A63:				; CODE XREF: __sbh_alloc_block+13Aj
		cmp	ebx, eax
		mov	[ebp+arg_0], ebx
		jb	short loc_404A5A

loc_404A6A:				; CODE XREF: __sbh_alloc_block+140j
		cmp	ebx, eax
		jnz	short loc_404A7C
...
loc_404A7C:				; CODE XREF: __sbh_alloc_block+136j
...
loc_404A94:				; CODE XREF: __sbh_alloc_block+15Cj
		xor	eax, eax
		jmp	loc_404C15
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_404A9B:				; CODE XREF: __sbh_alloc_block+182j
		shl	ecx, 1
		inc	edi

loc_404A9E:				; CODE XREF: __sbh_alloc_block+111j
					; __sbh_alloc_block+120j
		test	ecx, ecx
		jge	short loc_404A9B
		mov	ecx, [ebp+var_C]
		mov	edx, [ecx+edi*8+4]
		mov	ecx, [edx]
		sub	ecx, [ebp+var_10]
		...
		cmp	esi, 3Fh
		mov	[ebp+var_8], ecx
		jle	short loc_404ABF
		push	3Fh
		pop	esi

loc_404ABF:				; CODE XREF: __sbh_alloc_block+19Cj
		cmp	esi, edi
		jz	loc_404BC8
		mov	ecx, [edx+4]
		cmp	ecx, [edx+8]
...
loc_404AFF:				; CODE XREF: __sbh_alloc_block+1B9j
		lea	ecx, [edi-20h]
		shr	ebx, cl
		mov	ecx, [ebp+var_4]
...
loc_404B28:				; CODE XREF: __sbh_alloc_block+1D5j
					; __sbh_alloc_block+1FDj
		mov	ebx, [ebp+arg_0]

loc_404B2B:				; CODE XREF: __sbh_alloc_block+1AFj
		...
		mov	ecx, [edx+4]
		cmp	ecx, [edx+8]
		jnz	short loc_404BC5
		mov	cl, [esi+eax+4]
		mov	byte ptr [ebp+arg_0+3],	cl
		inc	cl
		cmp	esi, 20h
		mov	[esi+eax+4], cl
		jge	short loc_404B9C
		cmp	byte ptr [ebp+arg_0+3],	0
		jnz	short loc_404B8A
		mov	edi, 80000000h
		mov	ecx, esi
		shr	edi, cl
		or	[ebx], edi

loc_404B8A:				; CODE XREF: __sbh_alloc_block+25Fj
		mov	ecx, esi
		mov	edi, 80000000h
		shr	edi, cl
		mov	ecx, [ebp+var_4]
		or	[eax+ecx*4+44h], edi
		jmp	short loc_404BC5
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_404B9C:				; CODE XREF: __sbh_alloc_block+259j
		cmp	byte ptr [ebp+arg_0+3],	0
...
loc_404BAF:				; CODE XREF: __sbh_alloc_block+282j
		mov	ecx, [ebp+var_4]
...
loc_404BC5:				; CODE XREF: __sbh_alloc_block+247j
					; __sbh_alloc_block+27Cj
		mov	ecx, [ebp+var_8]

loc_404BC8:				; CODE XREF: __sbh_alloc_block+1A3j
		test	ecx, ecx
		jz	short loc_404BD7
		mov	[edx], ecx
		mov	[ecx+edx-4], ecx
		jmp	short loc_404BD7
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_404BD4:				; CODE XREF: __sbh_alloc_block+223j
		mov	ecx, [ebp+var_8]

loc_404BD7:				; CODE XREF: __sbh_alloc_block+2ACj
...
loc_404C0D:				; CODE XREF: __sbh_alloc_block+2D3j
					; __sbh_alloc_block+2DBj ...
		mov	ecx, [ebp+var_4]
		mov	[eax], ecx
		lea	eax, [edx+4]

loc_404C15:				; CODE XREF: __sbh_alloc_block+178j
		pop	edi
		pop	esi
		pop	ebx
		leave
...
arg_0		= dword	ptr  8
		...
		push	0
		push	0
		push	offset loc_404C34
		push	[ebp+arg_0]
		call	_RtlUnwind@16	; RtlUnwind(x,x,x,x)

loc_404C34:				; DATA XREF: __global_unwind2+Bo
		pop	ebp
		pop	edi
		pop	esi
		pop	ebx
...
arg_C		= dword	ptr  10h
		...
		mov	eax, 1
		jz	short locret_404C5D
		mov	eax, [esp+arg_4]
		mov	edx, [esp+arg_C]
		mov	[edx], eax
		mov	eax, 3

locret_404C5D:				; CODE XREF: __unwind_handler+10j
		retn
...
loc_404C7B:				; CODE XREF: __local_unwind2:__NLG_Return2j
...
__NLG_Return2:				; CODE XREF: __local_unwind2+44j
		jmp	short loc_404C7B
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_404CB8:				; CODE XREF: __local_unwind2+2Aj
...
locret_404CE8:				; CODE XREF: __abnormal_termination+10j
...
loc_404CFC:				; CODE XREF: _NLG_Notify1+7j
		mov	[ebx+8], ecx
		mov	[ebx+4], eax
		mov	[ebx+0Ch], ebp
...
arg_0		= dword	ptr  8
		...
		jb	short loc_404D3F
		cmp	ebx, [eax+4]
		jnb	short loc_404D3F

loc_404D38:				; CODE XREF: _ValidateEH3RN+11j
		xor	eax, eax
		jmp	loc_404F2F
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_404D3F:				; CODE XREF: _ValidateEH3RN+27j
					; _ValidateEH3RN+2Cj
		push	edi
		mov	edi, [esi+0Ch]
		cmp	edi, 0FFFFFFFFh
		jnz	short loc_404D50

loc_404D48:				; CODE XREF: _ValidateEH3RN+139j
...
loc_404D50:				; CODE XREF: _ValidateEH3RN+3Cj
		xor	edx, edx
		mov	[ebp+arg_0], edx
		mov	eax, ebx

loc_404D57:				; CODE XREF: _ValidateEH3RN+6Bj
		mov	ecx, [eax]
		cmp	ecx, 0FFFFFFFFh
		jz	short loc_404D66
		cmp	ecx, edx
...
loc_404D66:				; CODE XREF: _ValidateEH3RN+52j
		cmp	dword ptr [eax+4], 0
		jz	short loc_404D6F
		inc	[ebp+arg_0]

loc_404D6F:				; CODE XREF: _ValidateEH3RN+60j
		inc	edx
		add	eax, 0Ch
		cmp	edx, edi
		jbe	short loc_404D57
		cmp	[ebp+arg_0], 0
		jz	short loc_404D91
		mov	eax, [esi-8]
		cmp	eax, [ebp+var_4]
...
loc_404D91:				; CODE XREF: _ValidateEH3RN+71j
		mov	eax, nValidPages
		mov	edi, ebx
		and	edi, 0FFFFF000h
		xor	esi, esi
		test	eax, eax
		jle	short loc_404DB6

loc_404DA4:				; CODE XREF: _ValidateEH3RN+AAj
...
loc_404DB6:				; CODE XREF: _ValidateEH3RN+98j
		push	1Ch
		lea	eax, [ebp+var_20]
		push	eax
		push	ebx
...
loc_404E34:				; CODE XREF: _ValidateEH3RN+D2j
		...
		test	ecx, ecx
		mov	edx, ecx
		jle	short loc_404E68
		lea	eax, ds:40D5BCh[ecx*4]

loc_404E5C:				; CODE XREF: _ValidateEH3RN+15Cj
		cmp	[eax], edi
		jz	short loc_404E68
		dec	edx
		sub	eax, 4
...
loc_404E68:				; CODE XREF: _ValidateEH3RN+149j
...
loc_404E75:				; CODE XREF: _ValidateEH3RN+167j
		xor	edx, edx
		test	ebx, ebx
		jl	short loc_404E8D

loc_404E7B:				; CODE XREF: _ValidateEH3RN+181j
		...
		mov	[eax], edi
		mov	edi, esi
		jle	short loc_404E7B

loc_404E8D:				; CODE XREF: _ValidateEH3RN+16Fj
		cmp	ecx, 10h
		jge	short loc_404E99
		inc	ecx
		mov	nValidPages, ecx

loc_404E99:				; CODE XREF: _ValidateEH3RN+160j
...
loc_404EAB:				; CODE XREF: _ValidateEH3RN+56j
					; _ValidateEH3RN+79j ...
		xor	eax, eax
		jmp	short loc_404F2E
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_404EAF:				; CODE XREF: _ValidateEH3RN+A1j
		test	esi, esi
		jle	loc_404D48
...
loc_404EE3:				; CODE XREF: _ValidateEH3RN+1E3j
		cmp	rgValidPages[esi*4], edi
		jz	short loc_404EEF
		dec	esi
		jns	short loc_404EE3

loc_404EEF:				; CODE XREF: _ValidateEH3RN+1E0j
		test	esi, esi
		jge	short loc_404F03

loc_404EF3:				; CODE XREF: _ValidateEH3RN+1D7j
		cmp	eax, 10h
		jge	short loc_404EFE
		inc	eax
		mov	nValidPages, eax

loc_404EFE:				; CODE XREF: _ValidateEH3RN+1ECj
		lea	esi, [eax-1]
		jmp	short loc_404F05
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_404F03:				; CODE XREF: _ValidateEH3RN+1E7j
		jz	short loc_404F1D

loc_404F05:				; CODE XREF: _ValidateEH3RN+1CBj
					; _ValidateEH3RN+1F7j
		xor	ecx, ecx
		test	esi, esi
		jl	short loc_404F1D

loc_404F0B:				; CODE XREF: _ValidateEH3RN+211j
		...
		mov	[eax], edi
		mov	edi, edx
		jle	short loc_404F0B

loc_404F1D:				; CODE XREF: _ValidateEH3RN:loc_404F03j
...
loc_404F2B:				; CODE XREF: _ValidateEH3RN+BBj
					; _ValidateEH3RN+C8j ...
		or	eax, 0FFFFFFFFh

loc_404F2E:				; CODE XREF: _ValidateEH3RN+41j
					; _ValidateEH3RN+1A3j
		pop	edi

loc_404F2F:				; CODE XREF: _ValidateEH3RN+30j
		pop	esi
		pop	ebx
		leave
		retn
...
loc_404F61:				; CODE XREF: _callnewh+7j
					; _callnewh+12j
		xor	eax, eax
		retn
_callnewh	endp
...
loc_404FC7:				; CODE XREF: _write+1A9j
		xor	eax, eax
		jmp	loc_40513E
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_404FCE:				; CODE XREF: _write+61j
		test	al, 20h
		jz	short loc_404FDF
		push	2
		push	edi
...
loc_404FDF:				; CODE XREF: _write+6Cj
		mov	eax, [ebx]
		add	eax, esi
...
loc_405008:				; CODE XREF: _write+119j
		mov	ecx, [ebp-70h]
		sub	ecx, [ebp+3A8h]
		lea	eax, [ebp-6Ch]

loc_405014:				; CODE XREF: _write+DBj
		cmp	ecx, [ebp+3ACh]
		jnb	short loc_405041
		mov	edx, [ebp-70h]
		inc	dword ptr [ebp-70h]
		mov	dl, [edx]
		inc	ecx
		cmp	dl, 0Ah
		jnz	short loc_405032
		inc	dword ptr [ebp-7Ch]
		mov	byte ptr [eax],	0Dh
		inc	eax
		inc	edi

loc_405032:				; CODE XREF: _write+C4j
		mov	ebx, [ebp-80h]
		mov	[eax], dl
		inc	eax
		inc	edi
...
loc_405041:				; CODE XREF: _write+B6j
		mov	edi, eax
		lea	eax, [ebp-6Ch]
		sub	edi, eax
		push	0
...
loc_405081:				; CODE XREF: _write+FCj
		call	ds:__imp__GetLastError@0 ; __declspec(dllimport) GetLastError()
		mov	[ebp+3A4h], eax

loc_40508D:				; CODE XREF: _write+106j
		xor	edi, edi

loc_40508F:				; CODE XREF: _write+11Bj _write+179j ...
		mov	eax, [ebp-74h]
		cmp	eax, edi
		jnz	loc_405125
		cmp	[ebp+3A4h], edi
		...
		mov	_doserrno, eax
		jmp	short loc_405131
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4050B4:				; CODE XREF: _write+83j
		push	edi
		lea	ecx, [ebp-78h]
		push	ecx
...
loc_4050DF:				; CODE XREF: _write+16Bj
		call	ds:__imp__GetLastError@0 ; __declspec(dllimport) GetLastError()
		mov	[ebp+3A4h], eax
		jmp	short loc_40508F
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4050ED:				; CODE XREF: _write+147j
		push	dword ptr [ebp+3A4h]
		call	_dosmaperr
		pop	ecx
		jmp	short loc_40513B
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4050FB:				; CODE XREF: _write+9Ej _write+13Cj
		mov	eax, [ebx]
...
loc_405113:				; CODE XREF: _write+19Ej
		mov	errno, 1Ch
		mov	_doserrno, edi
		jmp	short loc_40513B
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_405125:				; CODE XREF: _write+130j
		sub	eax, [ebp-7Ch]
		jmp	short loc_40513E
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40512A:				; CODE XREF: _write+28j _write+4Dj
		and	_doserrno, 0

loc_405131:				; CODE XREF: _write+14Ej
		mov	errno, 9

loc_40513B:				; CODE XREF: _write+195j _write+1BFj
		or	eax, 0FFFFFFFFh

loc_40513E:				; CODE XREF: _write+65j _write+1C4j
		mov	ecx, [ebp+398h]
		pop	edi
		pop	esi
		pop	ebx
...
arg_0		= dword	ptr  4
		...
		test	eax, eax
		jnz	short loc_405192
		call	ds:__imp__GetLastError@0 ; __declspec(dllimport) GetLastError()
		jmp	short loc_405194
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_405192:				; CODE XREF: _commit+34j
		xor	eax, eax

loc_405194:				; CODE XREF: _commit+3Cj
		test	eax, eax
		jz	short locret_4051AA
		mov	_doserrno, eax

loc_40519D:				; CODE XREF: _commit+Aj _commit+22j
		mov	errno, 9
		or	eax, 0FFFFFFFFh

locret_4051AA:				; CODE XREF: _commit+42j
		retn
_commit		endp
...
arg_8		= dword	ptr  0Ch
		...
		mov	ebx, eax
		cmp	ebx, 0FFFFFFFFh
		jnz	short loc_405203
		call	ds:__imp__GetLastError@0 ; __declspec(dllimport) GetLastError()
		jmp	short loc_405205
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_405203:				; CODE XREF: _lseek+4Ej
		xor	eax, eax

loc_405205:				; CODE XREF: _lseek+56j
		test	eax, eax
		jz	short loc_405212
		push	eax
		call	_dosmaperr
...
loc_405212:				; CODE XREF: _lseek+5Cj
		mov	eax, [edi]
		lea	eax, [eax+esi+4]
		and	byte ptr [eax],	0FDh
		mov	eax, ebx
		jmp	short loc_405233
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40521F:				; CODE XREF: _lseek+Dj	_lseek+2Aj
		and	_doserrno, 0

loc_405226:				; CODE XREF: _lseek+36j
		mov	errno, 9

loc_405230:				; CODE XREF: _lseek+65j
		or	eax, 0FFFFFFFFh

loc_405233:				; CODE XREF: _lseek+72j
		pop	edi
		pop	esi
		pop	ebx
		retn
...
loc_405260:				; CODE XREF: _getbuf+1Aj
		or	dword ptr [ecx+0Ch], 4
		lea	eax, [ecx+14h]
		mov	[ecx+8], eax
		mov	dword ptr [ecx+18h], 2

loc_405271:				; CODE XREF: _getbuf+27j
		mov	eax, [ecx+8]
...
var_4		= dword	ptr -4
		...
		jz	short loc_40529A
		cmp	eax, 0BB40E64Eh
		jnz	short locret_4052E8

loc_40529A:				; CODE XREF: __security_init_cookie+Dj
		push	esi
		lea	eax, [ebp+var_8]
		push	eax
		...
		jnz	short loc_4052E7
		mov	__security_cookie, 0BB40E64Eh

loc_4052E7:				; CODE XREF: __security_init_cookie+57j
		pop	esi

locret_4052E8:				; CODE XREF: __security_init_cookie+14j
		leave
		retn
...
loc_405319:				; CODE XREF: __security_error_handler+3Fj
		or	dword ptr [ebp-4], 0FFFFFFFFh
		jmp	loc_40542A
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
		xor	eax, eax
...
loc_40532B:				; CODE XREF: __security_error_handler+20j
		mov	eax, [ebp+8]
		dec	eax
		jz	short loc_405347
...
loc_405347:				; CODE XREF: __security_error_handler+45j
...
loc_40535B:				; CODE XREF: __security_error_handler+5Bj
		mov	[ebp-20h], cl
		push	104h
		lea	eax, [ebp-124h]
		push	eax
...
loc_405388:				; CODE XREF: __security_error_handler+89j
		lea	ebx, [ebp-124h]
		mov	eax, ebx
		push	eax
		call	strlen
...
loc_4053C4:				; CODE XREF: __security_error_handler+B3j
		push	ebx
		call	strlen
		pop	ecx
		lea	eax, [eax+esi+0Ch]
...
loc_40542A:				; CODE XREF: __security_error_handler+33j
		push	3		; int
		call	_exit
		int	3		; Trap to Debugger
...
loc_405483:				; CODE XREF: memset+2Bj
		mov	[edi], al
		add	edi, 1
		sub	ecx, 1
		jnz	short loc_405483

loc_40548D:				; CODE XREF: memset+1Fj
		mov	ecx, eax
		shl	eax, 8
		add	eax, ecx
		mov	ecx, eax
...
loc_4054AB:				; CODE XREF: memset+18j memset+43j ...
		mov	[edi], al
		add	edi, 1
		sub	edx, 1
		jnz	short loc_4054AB

loc_4054B5:				; CODE XREF: memset+49j
		mov	eax, [esp+4+arg_0]
		pop	edi
		retn
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4054BB:				; CODE XREF: memset+Aj
		mov	eax, [esp+arg_0]
		retn
memset		endp
...
loc_4054D5:				; CODE XREF: fclose+Ej
		test	al, 83h
		jz	short loc_40550D
		push	esi
		call	_flush
		...
		add	esp, 0Ch
		test	eax, eax
		jge	short loc_4054FB
		or	edi, 0FFFFFFFFh
		jmp	short loc_40550D
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4054FB:				; CODE XREF: fclose+34j
		mov	eax, [esi+1Ch]
		test	eax, eax
		jz	short loc_40550D
		push	eax
...
loc_40550D:				; CODE XREF: fclose+17j fclose+39j ...
		mov	eax, edi

loc_40550F:				; CODE XREF: fclose+13j
...
loc_405530:				; CODE XREF: realloc+9j
		push	esi
		mov	esi, [esp+0Ch+arg_4]
		test	esi, esi
		jnz	short loc_405545
		push	ebx
		call	free
		pop	ecx
		jmp	loc_405671
...
loc_405545:				; CODE XREF: realloc+21j
		cmp	__active_heap, 3
		jnz	loc_40563D

loc_405552:				; CODE XREF: realloc+11Bj
		xor	edi, edi
		cmp	esi, 0FFFFFFE0h
		ja	loc_40561F
		push	ebx
		...
		jz	short loc_405589
		mov	edi, ebx
		jmp	short loc_4055BA
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_405589:				; CODE XREF: realloc+6Dj
		push	esi
		call	__sbh_alloc_block
		mov	edi, eax
		test	edi, edi
...
loc_4055A0:				; CODE XREF: realloc+86j
		push	eax
		push	ebx
		push	edi
		call	memcpy
...
loc_4055BA:				; CODE XREF: realloc+71j
		test	edi, edi
		jnz	short loc_4055FA

loc_4055BE:				; CODE XREF: realloc+5Ej realloc+7Ej
		test	esi, esi
		jnz	short loc_4055C3
		inc	esi

loc_4055C3:				; CODE XREF: realloc+AAj
		add	esi, 0Fh
		and	esi, 0FFFFFFF0h
		push	esi
		push	0
...
loc_4055E8:				; CODE XREF: realloc+CEj
		push	eax
		push	ebx
		push	edi
		call	memcpy
...
loc_4055FA:				; CODE XREF: realloc+A6j realloc+C6j
		test	ebp, ebp
		jnz	short loc_40561B

loc_4055FE:				; CODE XREF: realloc+52j
		test	esi, esi
		jnz	short loc_405603
		inc	esi

loc_405603:				; CODE XREF: realloc+EAj
		add	esi, 0Fh
		and	esi, 0FFFFFFF0h
		push	esi
		push	ebx
...
loc_40561B:				; CODE XREF: realloc+E6j
		test	edi, edi
		jnz	short loc_405639

loc_40561F:				; CODE XREF: realloc+41j
		cmp	_newmode, 0
		jz	short loc_405639
		push	esi
		call	_callnewh
		...
		pop	ecx
		jnz	loc_405552
		jmp	short loc_405671
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_405639:				; CODE XREF: realloc+107j realloc+110j
		mov	eax, edi
		jmp	short loc_405673
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40563D:				; CODE XREF: realloc+36j realloc+159j
		xor	eax, eax
		cmp	esi, 0FFFFFFE0h
		ja	short loc_40565D
		test	esi, esi
...
loc_405649:				; CODE XREF: realloc+130j
		push	esi
		push	ebx
		push	0
		push	_crtheap
...
loc_40565D:				; CODE XREF: realloc+12Cj
		cmp	_newmode, 0
		jz	short loc_405673
		push	esi
		call	_callnewh
...
loc_405671:				; CODE XREF: realloc+2Aj realloc+121j
		xor	eax, eax

loc_405673:				; CODE XREF: realloc+125j realloc+145j ...
		pop	esi

loc_405674:				; CODE XREF: realloc+15j
		pop	edi
		pop	ebp
		pop	ebx
		retn
...
loc_405699:				; CODE XREF: _msize+17j
		push	esi
		jmp	short loc_4056A0
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40569C:				; CODE XREF: _msize+8j
		push	[esp+4+arg_0]

loc_4056A0:				; CODE XREF: _msize+22j
		push	0
		push	_crtheap
...
loc_4056B8:				; CODE XREF: strncnt+11j
		dec	ecx
		cmp	byte ptr [eax],	0
		jz	short loc_4056C4
		inc	eax
...
loc_4056C3:				; CODE XREF: strncnt+6j
		dec	ecx

loc_4056C4:				; CODE XREF: strncnt+Cj
		mov	eax, [esp+arg_0]
		sub	eax, ecx
		dec	eax
		retn
...
loc_405705:				; CODE XREF: __crtLCMapStringA+2Fj
		call	ds:__imp__GetLastError@0 ; __declspec(dllimport) GetLastError()
		cmp	eax, 78h
		jnz	short loc_40571A
		mov	dword_40D630, 2

loc_40571A:				; CODE XREF: __crtLCMapStringA+14j
					; __crtLCMapStringA+37j ...
		cmp	[ebp+14h], ebx
		jle	short loc_40573A
		mov	ecx, [ebp+14h]
		mov	eax, [ebp+10h]

loc_405725:				; CODE XREF: __crtLCMapStringA+61j
		dec	ecx
		cmp	[eax], bl
		jz	short loc_405732
		inc	eax
...
loc_405732:				; CODE XREF: __crtLCMapStringA+5Cj
		or	eax, 0FFFFFFFFh
		sub	eax, ecx
		add	[ebp+14h], eax

loc_40573A:				; CODE XREF: __crtLCMapStringA+51j
...
loc_405771:				; CODE XREF: __crtLCMapStringA+9Bj
		push	ebx
		push	ebx
...
loc_4057DD:				; CODE XREF: __crtLCMapStringA+F4j
		cmp	[ebp-1Ch], ebx
		jnz	short loc_4057FE
		lea	eax, [esi+esi]
		push	eax
		call	malloc
		pop	ecx
...
loc_4057FE:				; CODE XREF: __crtLCMapStringA+114j
		push	esi
...
loc_40586D:				; CODE XREF: __crtLCMapStringA+172j
...
loc_4058AB:				; CODE XREF: __crtLCMapStringA+1C2j
		cmp	[ebp-20h], ebx
		jnz	short loc_4058C8
		lea	eax, [edi+edi]
		push	eax
		call	malloc
		pop	ecx
...
loc_4058C8:				; CODE XREF: __crtLCMapStringA+1E2j
		push	edi
		push	dword ptr [ebp-20h]
		push	esi
		push	dword ptr [ebp-1Ch]
		...
		push	ebx
		push	ebx
		jmp	short loc_4058F1
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4058EB:				; CODE XREF: __crtLCMapStringA+219j
		push	dword ptr [ebp+1Ch]
		push	dword ptr [ebp+18h]

loc_4058F1:				; CODE XREF: __crtLCMapStringA+21Dj
		push	edi
		push	dword ptr [ebp-20h]
		push	ebx
		push	dword ptr [ebp+20h]
...
loc_405901:				; CODE XREF: __crtLCMapStringA+149j
...
loc_40590F:				; CODE XREF: __crtLCMapStringA+238j
		cmp	[ebp-38h], ebx
		jz	short loc_40591D
		push	dword ptr [ebp-1Ch]
		call	free
...
loc_40591D:				; CODE XREF: __crtLCMapStringA+246j
		mov	eax, edi
		jmp	loc_405A7F
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_405924:				; CODE XREF: __crtLCMapStringA+76j
...
loc_405939:				; CODE XREF: __crtLCMapStringA+263j
		cmp	[ebp+20h], ebx
		jnz	short loc_405946
		mov	eax, __lc_codepage
		mov	[ebp+20h], eax

loc_405946:				; CODE XREF: __crtLCMapStringA+270j
		push	dword ptr [ebp+8]
		call	__ansicp
		pop	ecx
		mov	[ebp-40h], eax
		cmp	eax, 0FFFFFFFFh
		jnz	short loc_40595E

loc_405957:				; CODE XREF: __crtLCMapStringA+87j
					; __crtLCMapStringA+CDj ...
		xor	eax, eax
		jmp	loc_405A7F
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40595E:				; CODE XREF: __crtLCMapStringA+289j
		cmp	eax, [ebp+20h]
		jz	loc_405A55
		push	ebx
		push	ebx
...
loc_4059D5:				; CODE XREF: __crtLCMapStringA+2F7j
		or	dword ptr [ebp-4], 0FFFFFFFFh
		cmp	edi, ebx
		jnz	short loc_405A00
...
loc_405A00:				; CODE XREF: __crtLCMapStringA+30Fj
		push	dword ptr [ebp-24h]
		push	edi
		push	dword ptr [ebp+14h]
		...
		mov	[ebp-24h], eax
		cmp	eax, ebx
		jnz	short loc_405A21

loc_405A1D:				; CODE XREF: __crtLCMapStringA+31Ej
		xor	esi, esi
		jmp	short loc_405A47
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_405A21:				; CODE XREF: __crtLCMapStringA+34Fj
		push	dword ptr [ebp+1Ch]
		push	dword ptr [ebp+18h]
		lea	eax, [ebp-24h]
		push	eax
...
loc_405A44:				; CODE XREF: __crtLCMapStringA+2D0j
		mov	esi, [ebp-48h]

loc_405A47:				; CODE XREF: __crtLCMapStringA+353j
...
loc_405A55:				; CODE XREF: __crtLCMapStringA+295j
		push	dword ptr [ebp+1Ch]
		push	dword ptr [ebp+18h]
		push	dword ptr [ebp+14h]
		push	dword ptr [ebp+10h]
...
loc_405A6F:				; CODE XREF: __crtLCMapStringA+37Ej
...
loc_405A7D:				; CODE XREF: __crtLCMapStringA+3A6j
		mov	eax, esi

loc_405A7F:				; CODE XREF: __crtLCMapStringA+253j
...
__crtGetStringTypeA proc near		; CODE XREF: setSBUpLow+A1p
		...
		jmp	short loc_405AD3
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_405ABE:				; CODE XREF: __crtGetStringTypeA+2Cj
		call	ds:__imp__GetLastError@0 ; __declspec(dllimport) GetLastError()
		cmp	eax, 78h
		jnz	short loc_405AD3
		mov	dword_40D634, 2

loc_405AD3:				; CODE XREF: __crtGetStringTypeA+14j
...
loc_405B05:				; CODE XREF: __crtGetStringTypeA+73j
		push	esi
		push	esi
		push	dword ptr [ebp+10h]
		push	dword ptr [ebp+0Ch]
...
loc_405B76:				; CODE XREF: __crtGetStringTypeA+D7j
		test	esi, esi
...
loc_405B91:				; CODE XREF: __crtGetStringTypeA+F0j
		push	edi
		push	esi
		push	dword ptr [ebp+10h]
		push	dword ptr [ebp+0Ch]
...
loc_405BB9:				; CODE XREF: __crtGetStringTypeA+11Ej
...
loc_405BC6:				; CODE XREF: __crtGetStringTypeA+135j
		mov	eax, [ebp-24h]
		jmp	short loc_405C39
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_405BCB:				; CODE XREF: __crtGetStringTypeA+53j
					; __crtGetStringTypeA+5Bj
		mov	ebx, [ebp+1Ch]
		cmp	ebx, esi
		jnz	short loc_405BD8
		mov	ebx, dword_40D614

loc_405BD8:				; CODE XREF: __crtGetStringTypeA+148j
		mov	edi, [ebp+18h]
		test	edi, edi
		jnz	short loc_405BE5
		mov	edi, __lc_codepage

loc_405BE5:				; CODE XREF: __crtGetStringTypeA+155j
		push	ebx
		call	__ansicp
		pop	ecx
		cmp	eax, 0FFFFFFFFh
		jnz	short loc_405BF5

loc_405BF1:				; CODE XREF: __crtGetStringTypeA+64j
					; __crtGetStringTypeA+A5j ...
		xor	eax, eax
		jmp	short loc_405C39
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_405BF5:				; CODE XREF: __crtGetStringTypeA+167j
		cmp	eax, edi
		jz	short loc_405C17
		push	0
		push	0
...
loc_405C17:				; CODE XREF: __crtGetStringTypeA+16Fj
		push	dword ptr [ebp+14h]
		push	dword ptr [ebp+10h]
		push	dword ptr [ebp+0Ch]
		push	dword ptr [ebp+8]
...
loc_405C37:				; CODE XREF: __crtGetStringTypeA+1A6j
		mov	eax, edi

loc_405C39:				; CODE XREF: __crtGetStringTypeA+141j
...
memmove:				; CODE XREF: __sbh_free_block+2DEp
		...
		add	eax, esi
		cmp	edi, esi
		jbe	short loc_405C70
		cmp	edi, eax
		jb	loc_405DEC

loc_405C70:				; CODE XREF: .text:00405C66j
		test	edi, 3
		jnz	short loc_405C8C
		shr	ecx, 2
		and	edx, 3
		cmp	ecx, 8
		jb	short near ptr dword_405CAC
		rep movsd
		jmp	ds:TrailUpVec[edx*4]
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_405C8C:				; CODE XREF: .text:00405C76j
		mov	eax, edi
		mov	edx, 3
		sub	ecx, 4
		jb	short loc_405CA4
		and	eax, 3
		add	ecx, eax
		jmp	ds:dword_405CB0[eax*4]
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_405CA4:				; CODE XREF: .text:00405C96j
		jmp	dword ptr ds:loc_405DAC[ecx*4]
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
		align 4
dword_405CAC	dd 308D24FFh		; CODE XREF: .text:00405C81j
dword_405CB0	dd 9000405Dh		; DATA XREF: .text:00405C9Dr

; ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ S U B	R O U T	I N E ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ


LeadUpVec	proc near
		rcr	byte ptr [eax+eax*2+0],	0ECh
		pop	esp
		inc	eax
		add	[eax], dl
		pop	ebp
		...
		add	[eax+468A0147h], ecx
		add	al, cl
		jmp	near ptr 287E4D7h
LeadUpVec	endp

; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
		dd 8303C683h, 0F98303C7h, 0F3CC7208h, 9524FFA5h, 405D9Ch
		dd 2300498Dh, 88068AD1h, 1468A07h, 8802E9C1h, 0C6830147h
		dd 2C78302h, 7208F983h,	0FFA5F3A6h, 5D9C9524h, 23900040h
		dd 88068AD1h, 1C68307h,	8302E9C1h, 0F98301C7h, 0F3887208h
		dd 9524FFA5h, 405D9Ch
		align 10h
...
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
		align 4
TrailUpVec	dd offset loc_405DAC	; DATA XREF: .text:00405C85r
					; UnwindUpVec+63r
		dd offset loc_405DB4
		dd offset loc_405DC0
		dd offset loc_405DD4
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_405DAC:				; CODE XREF: .text:00405C85j
					; UnwindUpVec+63j
					; DATA XREF: ...
		mov	eax, [ebp+8]
		pop	esi
...
loc_405DC0:				; CODE XREF: UnwindUpVec+63j
...
loc_405DD4:				; CODE XREF: UnwindUpVec+63j
...
loc_405DEC:				; CODE XREF: .text:00405C6Aj
		lea	esi, [ecx+esi-4]
		lea	edi, [ecx+edi-4]
		test	edi, 3
		jnz	short loc_405E20
		shr	ecx, 2
		and	edx, 3
		cmp	ecx, 8
		jb	short loc_405E14
...
loc_405E14:				; CODE XREF: .text:00405E05j
					; .text:00405E60j ...
		neg	ecx
		jmp	dword ptr ds:loc_405EE7+1[ecx*4]
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
		align 10h

loc_405E20:				; CODE XREF: .text:00405DFAj
		mov	eax, edi
		mov	edx, 3
		cmp	ecx, 4
		jb	short near ptr dword_405E38
		and	eax, 3
		sub	ecx, eax
		jmp	ds:dword_405E3C[eax*4]
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
dword_405E38	dd 388D24FFh		; CODE XREF: .text:00405E2Aj
dword_405E3C	dd 9000405Fh		; DATA XREF: .text:00405E31r
...
LeadDownVec	proc near
		...
		add	[eax+5Eh], dh
		inc	eax
		add	[eax-75FFBFA2h], bl
		inc	esi
		add	esp, [ebx]
		ror	dword ptr [eax-117CFCB9h], 1
		add	ecx, eax
		jmp	near ptr 22FE15Fh
LeadDownVec	endp
...
loc_405EE7:				; DATA XREF: .text:00405E16r
		add	[edi], ch
		pop	edi
		inc	eax
		add	[ebx-76E371BCh], cl
...
TrailDownVec	proc near		; DATA XREF: .text:00405E0Br
					; .text:00405E66r ...
		dec	eax
		pop	edi
		inc	eax
...
loc_405F98:				; CODE XREF: _dosmaperr+18j
...
loc_405FBC:				; CODE XREF: _dosmaperr+12j
		mov	eax, dword_40D064[ecx*8]
		mov	errno, eax
		retn
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_405FC9:				; CODE XREF: _dosmaperr+1Dj
					; _dosmaperr+22j
		cmp	eax, 0BCh
		jb	short loc_405FE1
		cmp	eax, 0CAh
		mov	errno, 8
		jbe	short locret_405FEB

loc_405FE1:				; CODE XREF: _dosmaperr+41j
		mov	errno, 16h

locret_405FEB:				; CODE XREF: _dosmaperr+52j
		retn
_dosmaperr	endp
...
loc_40605F:				; CODE XREF: _lseeki64+5Ej
					; _lseeki64+68j
		mov	eax, [edi]
		lea	eax, [eax+esi+4]
		and	byte ptr [eax],	0FDh
...
loc_406070:				; CODE XREF: _lseeki64+10j
					; _lseeki64+2Dj
		and	_doserrno, 0

loc_406077:				; CODE XREF: _lseeki64+45j
		mov	errno, 9

loc_406081:				; CODE XREF: _lseeki64+71j
		or	eax, 0FFFFFFFFh
		or	edx, 0FFFFFFFFh

loc_406087:				; CODE XREF: _lseeki64+82j
		pop	edi
		pop	esi
		leave
		retn
...
loc_4060A0:				; CODE XREF: _alloc_osfhnd+54j
		mov	eax, [ecx]
		test	eax, eax
		jz	short loc_4060E3
		lea	ebp, [eax+100h]
		jmp	short loc_4060BB
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4060AE:				; CODE XREF: _alloc_osfhnd+32j
...
loc_4060BB:				; CODE XREF: _alloc_osfhnd+21j
		cmp	eax, ebp
		jb	short loc_4060AE
		jmp	short loc_4060D2
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4060C1:				; CODE XREF: _alloc_osfhnd+27j
		or	dword ptr [eax], 0FFFFFFFFh
		sub	eax, [ecx]
		sar	eax, 3
		add	eax, edx
		mov	ebx, eax
		cmp	ebx, 0FFFFFFFFh
		jnz	short loc_406121

loc_4060D2:				; CODE XREF: _alloc_osfhnd+34j
		add	ecx, 4
		inc	esi
		add	edx, 20h
		cmp	ecx, offset __env_initialized
		jl	short loc_4060A0
		jmp	short loc_406121
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4060E3:				; CODE XREF: _alloc_osfhnd+19j
		push	edi
		call	malloc
		test	eax, eax
		pop	ecx
...
loc_406106:				; CODE XREF: _alloc_osfhnd+8Fj
		or	dword ptr [eax], 0FFFFFFFFh
		mov	byte ptr [eax+4], 0
		mov	byte ptr [eax+5], 0Ah
		mov	edx, [ecx]
...
loc_406118:				; CODE XREF: _alloc_osfhnd+79j
		cmp	eax, edx
		jb	short loc_406106
		shl	esi, 5
		mov	ebx, esi

loc_406121:				; CODE XREF: _alloc_osfhnd+45j
					; _alloc_osfhnd+56j ...
		pop	edi
		pop	esi
		pop	ebp
...
loc_406170:				; CODE XREF: _set_osfhnd+3Ej
		push	ebx
		push	0FFFFFFF5h
		jmp	short loc_406178
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_406175:				; CODE XREF: _set_osfhnd+3Bj
		push	ebx
		push	0FFFFFFF6h

loc_406178:				; CODE XREF: _set_osfhnd+46j
					; _set_osfhnd+4Bj
		call	ds:__imp__SetStdHandle@8 ; __declspec(dllimport) SetStdHandle(x,x)

loc_40617E:				; CODE XREF: _set_osfhnd+36j
					; _set_osfhnd+41j
		mov	eax, [edi]
		mov	[esi+eax], ebx
		xor	eax, eax
...
loc_406188:				; CODE XREF: _set_osfhnd+Cj
					; _set_osfhnd+28j
		and	_doserrno, 0
		mov	errno, 9
		or	eax, 0FFFFFFFFh

loc_40619C:				; CODE XREF: _set_osfhnd+5Ej
		pop	edi
		pop	esi
		retn
_set_osfhnd	endp
...
loc_4061EA:				; CODE XREF: _free_osfhnd+41j
		push	eax
		push	0FFFFFFF5h
		jmp	short loc_4061F2
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4061EF:				; CODE XREF: _free_osfhnd+3Ej
		push	eax
		push	0FFFFFFF6h

loc_4061F2:				; CODE XREF: _free_osfhnd+49j
					; _free_osfhnd+4Ej
		call	ds:__imp__SetStdHandle@8 ; __declspec(dllimport) SetStdHandle(x,x)

loc_4061F8:				; CODE XREF: _free_osfhnd+38j
					; _free_osfhnd+44j
		mov	eax, [edi]
...
loc_406202:				; CODE XREF: _free_osfhnd+Cj
					; _free_osfhnd+2Aj ...
		and	_doserrno, 0
		mov	errno, 9
		or	eax, 0FFFFFFFFh

loc_406216:				; CODE XREF: _free_osfhnd+61j
		pop	edi
		pop	esi
		retn
_free_osfhnd	endp
...
loc_406240:				; CODE XREF: _get_osfhandle+Aj
					; _get_osfhandle+22j
		and	_doserrno, 0
		mov	errno, 9
		or	eax, 0FFFFFFFFh
...
loc_406264:				; CODE XREF: _open_osfhandle+Aj
		test	[ebp+arg_5], 40h
		jz	short loc_40626D
		or	bl, 80h

loc_40626D:				; CODE XREF: _open_osfhandle+13j
		test	[ebp+arg_4], 80h
		jz	short loc_406276
		or	bl, 10h

loc_406276:				; CODE XREF: _open_osfhandle+1Cj
		push	[ebp+arg_0]
		call	ds:__imp__GetFileType@4	; __declspec(dllimport)	GetFileType(x)
		test	eax, eax
		...
		pop	ecx
		or	eax, 0FFFFFFFFh
		jmp	short loc_4062EF
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_406295:				; CODE XREF: _open_osfhandle+2Cj
		cmp	eax, 2
...
loc_40629F:				; CODE XREF: _open_osfhandle+43j
		cmp	eax, 3
		jnz	short loc_4062A7
		or	bl, 8

loc_4062A7:				; CODE XREF: _open_osfhandle+48j
		...
		and	_doserrno, 0
		mov	errno, 18h
		jmp	short loc_4062EE
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4062C9:				; CODE XREF: _open_osfhandle+5Fj
		push	[ebp+arg_0]
		push	esi
		call	_set_osfhnd
		pop	ecx
...
loc_4062EE:				; CODE XREF: _open_osfhandle+72j
		pop	esi

loc_4062EF:				; CODE XREF: _open_osfhandle+3Ej
		pop	ebx
		pop	ebp
		retn
...
loc_406339:				; CODE XREF: _close+40j
		push	2
		call	_get_osfhandle
		push	1
		mov	ebp, eax
...
loc_40634F:				; CODE XREF: _close+45j
		push	edi
		call	_get_osfhandle
		pop	ecx
		push	eax
		...
		call	ds:__imp__GetLastError@0 ; __declspec(dllimport) GetLastError()
		mov	ebp, eax
		jmp	short loc_40636D
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40636B:				; CODE XREF: _close+3Bj _close+5Bj ...
		xor	ebp, ebp

loc_40636D:				; CODE XREF: _close+77j
		push	edi
		call	_free_osfhnd
		test	ebp, ebp
		mov	eax, [ebx]
		...
		call	_dosmaperr
		pop	ecx
		jmp	short loc_40639D
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_406388:				; CODE XREF: _close+8Bj
		xor	eax, eax
		jmp	short loc_4063A0
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40638C:				; CODE XREF: _close+Ej	_close+2Fj
		and	_doserrno, 0
		mov	errno, 9

loc_40639D:				; CODE XREF: _close+94j
		or	eax, 0FFFFFFFFh

loc_4063A0:				; CODE XREF: _close+98j
		pop	edi
		pop	esi
		pop	ebp
		pop	ebx
...
loc_4063CE:				; CODE XREF: _freebuf+Aj _freebuf+Ej
		pop	esi
		retn
_freebuf	endp
...
arg_0		= dword	ptr  8
		...
		or	eax, 0FFFFFFFFh
		jmp	short loc_406409
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4063FF:				; CODE XREF: __ansicp+28j
		lea	eax, [ebp+var_C]
		push	eax
		call	atol
		pop	ecx

loc_406409:				; CODE XREF: __ansicp+2Dj
		mov	ecx, [ebp+var_4]
		call	__security_check_cookie
		leave
		retn
...
loc_406477:				; CODE XREF: __convertcp+42j
					; __convertcp+48j ...
		cmp	[ebp-3Ch], edi
		jz	short loc_406496
		cmp	ebx, 0FFFFFFFFh
		jz	short loc_406485
		mov	esi, ebx
		jmp	short loc_406491
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_406485:				; CODE XREF: __convertcp+6Cj
		push	dword ptr [ebp+10h]
		call	strlen
		pop	ecx
		mov	esi, eax
...
loc_406491:				; CODE XREF: __convertcp+70j
		mov	[ebp-38h], esi
		jmp	short loc_406499
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_406496:				; CODE XREF: __convertcp+67j
		mov	esi, [ebp-38h]

loc_406499:				; CODE XREF: __convertcp+81j
		cmp	[ebp-3Ch], edi
...
loc_4064B8:				; CODE XREF: __convertcp+89j
		mov	[ebp-4], edi
		lea	eax, [esi+esi]
		add	eax, 3
		and	eax, 0FFFFFFFCh
...
loc_4064FC:				; CODE XREF: __convertcp+D0j
		cmp	ebx, edi
		jnz	short loc_40651E
		push	esi
		push	2
		call	calloc
		pop	ecx
		...
		mov	ebx, eax
		cmp	ebx, edi
		jnz	short loc_406517

loc_406510:				; CODE XREF: __convertcp+A3j
		xor	eax, eax
		jmp	loc_4065CB
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_406517:				; CODE XREF: __convertcp+FBj
		mov	dword ptr [ebp-44h], 1

loc_40651E:				; CODE XREF: __convertcp+EBj
		push	esi
		push	ebx
		push	dword ptr [ebp-40h]
		push	dword ptr [ebp+10h]
...
loc_40655E:				; CODE XREF: __convertcp+129j
		cmp	[ebp-3Ch], edi
		jnz	short loc_406579
		push	edi
		push	edi
		push	edi
		push	edi
...
loc_406579:				; CODE XREF: __convertcp+14Ej
		push	esi
		push	1
		call	calloc
		pop	ecx
...
loc_4065AC:				; CODE XREF: __convertcp+189j
...
loc_4065B9:				; CODE XREF: __convertcp+2Dj
		mov	ebx, [ebp-48h]

loc_4065BC:				; CODE XREF: __convertcp+120j
					; __convertcp+141j ...
		cmp	[ebp-44h], edi
		jz	short loc_4065C8
		push	ebx
...
loc_4065C8:				; CODE XREF: __convertcp+1ACj
		mov	eax, [ebp-34h]

loc_4065CB:				; CODE XREF: __convertcp+FFj
		lea	esp, [ebp-54h]
		mov	ecx, [ebp-1Ch]
		call	__security_check_cookie
		call	__SEH_epilog
...
loc_406644:				; CODE XREF: _resetstkoflw+84j
		push	1Ch
		lea	eax, [ebp+var_28]
		push	eax
		push	[ebp+var_4]
		...
		xor	eax, eax
		inc	eax
		jmp	short loc_4066B7
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_406673:				; CODE XREF: _resetstkoflw+90j
		cmp	edi, eax
		jnb	short loc_40667B

loc_406677:				; CODE XREF: _resetstkoflw+22j
					; _resetstkoflw+59j ...
		xor	eax, eax
		jmp	short loc_4066B7
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40667B:				; CODE XREF: _resetstkoflw+99j
		cmp	eax, esi
		jnb	short loc_406682
		mov	[ebp+var_4], esi

loc_406682:				; CODE XREF: _resetstkoflw+A1j
		push	4
		push	ebx
		push	[ebp+var_8]
		push	[ebp+var_4]
		call	ds:__imp__VirtualAlloc@16 ; __declspec(dllimport) VirtualAlloc(x,x,x,x)
		mov	eax, _osplatform
		jmp	short loc_40669B
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_406698:				; CODE XREF: _resetstkoflw+5Ej
		mov	[ebp+var_4], edi

loc_40669B:				; CODE XREF: _resetstkoflw+BAj
		dec	eax
		neg	eax
		sbb	eax, eax
		and	eax, 103h
...
loc_4066B7:				; CODE XREF: _resetstkoflw+95j
					; _resetstkoflw+9Dj
		lea	esp, [ebp-58h]
		pop	edi
		pop	esi
...
arg_0		= dword	ptr  8
		...
		push	esi
		mov	esi, [esp+arg_0]
		jmp	short loc_4066C7
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4066C6:				; CODE XREF: atol+14j
		inc	esi

loc_4066C7:				; CODE XREF: atol+5j
		...
		jz	short loc_4066E5
		cmp	ecx, 2Bh
		jnz	short loc_4066E9

loc_4066E5:				; CODE XREF: atol+1Fj
		movzx	ecx, byte ptr [esi]
		inc	esi

loc_4066E9:				; CODE XREF: atol+24j
		xor	eax, eax

loc_4066EB:				; CODE XREF: atol+4Dj
		cmp	ecx, 30h
		jl	short loc_4066FA
		cmp	ecx, 39h
		jg	short loc_4066FA
...
loc_4066FA:				; CODE XREF: atol+2Fj atol+34j
		or	ecx, 0FFFFFFFFh

loc_4066FD:				; CODE XREF: atol+39j
		cmp	ecx, 0FFFFFFFFh
		jz	short loc_40670E
		lea	eax, [eax+eax*4]
		lea	eax, [ecx+eax*2]
...
loc_40670E:				; CODE XREF: atol+41j
		cmp	edx, 2Dh
		pop	esi
		jnz	short locret_406716
		neg	eax

locret_406716:				; CODE XREF: atol+53j
		retn
atol		endp
...
loc_406726:				; CODE XREF: _atoi64+17j
		inc	edi

loc_406727:				; CODE XREF: _atoi64+8j
...
loc_406745:				; CODE XREF: _atoi64+22j
		movzx	esi, byte ptr [edi]
		inc	edi

loc_406749:				; CODE XREF: _atoi64+27j
		xor	eax, eax
		xor	edx, edx

loc_40674D:				; CODE XREF: _atoi64+66j
		cmp	esi, 30h
		jl	short loc_40675C
		cmp	esi, 39h
		jg	short loc_40675C
		sub	esi, 30h
		jmp	short loc_40675F
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_40675C:				; CODE XREF: _atoi64+34j _atoi64+39j
		or	esi, 0FFFFFFFFh

loc_40675F:				; CODE XREF: _atoi64+3Ej
		cmp	esi, 0FFFFFFFFh
		jz	short loc_406784
		push	0
		push	0Ah
		...
		mov	edx, ebp
		inc	edi
		jmp	short loc_40674D
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_406784:				; CODE XREF: _atoi64+46j
		pop	edi
		pop	esi
		pop	ebp
		cmp	ebx, 2Dh
		pop	ebx
		jnz	short locret_406794
		neg	eax
		adc	edx, 0
		neg	edx

locret_406794:				; CODE XREF: _atoi64+6Fj
		retn
_atoi64		endp
...
arg_0		= dword	ptr  8
		...
		mov	byte ptr [ebp+arg_0+3],	cl
		pop	edi
		jnz	short loc_4067CA

loc_4067C6:				; CODE XREF: _ismbcspace+59j
					; _ismbcspace+60j ...
		xor	eax, eax
		leave
		retn
...
loc_4067CA:				; CODE XREF: _ismbcspace+2Fj
		push	1
		push	__mblcid
		lea	eax, [ebp+var_4]
		push	__mbcodepage
...
loc_406802:				; CODE XREF: _ismbcspace+Dj
		cmp	__mb_cur_max, 1
		jle	short loc_406817
		push	8
		push	ecx
		call	_isctype
		pop	ecx
...
loc_406817:				; CODE XREF: _ismbcspace+74j
		mov	eax, _pctype
...
arg_C		= dword	ptr  10h
		...
		or	ecx, eax
		mov	ecx, [esp+arg_8]
		jnz	short loc_406849
		mov	eax, [esp+arg_0]
		mul	ecx
		retn	10h
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_406849:				; CODE XREF: _allmul+Ej
		push	ebx
		mul	ecx
		mov	ebx, eax
		mov	eax, [esp+4+arg_0]
...
arg_4		= dword	ptr  0Ch
		...
		mov	ecx, _pctype
		movzx	eax, word ptr [ecx+eax*2]
		jmp	short loc_4068F0
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_406895:				; CODE XREF: _isctype+10j
		mov	ecx, eax
		sar	ecx, 8
		push	esi
		mov	esi, _pctype
		...
		mov	[ebp+var_2], 0
		pop	eax
		jmp	short loc_4068C5
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

loc_4068BB:				; CODE XREF: _isctype+33j
		mov	[ebp+var_4], al
		xor	eax, eax
		mov	byte ptr [ebp-3], 0
		inc	eax

loc_4068C5:				; CODE XREF: _isctype+42j
		push	1
		push	dword_40D614
		lea	ecx, [ebp+arg_0+2]
		push	__lc_codepage
...
loc_4068EC:				; CODE XREF: _isctype+71j
		movzx	eax, word ptr [ebp+arg_0+2]

loc_4068F0:				; CODE XREF: _isctype+1Cj
		and	eax, [ebp+arg_4]
		leave
		retn
_isctype	endp
...
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
		...
		db 'ÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌ'
		db 'ÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌ'
		db 'ÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌÌ',0
		align 1000h
_text		ends
...
byte_40A010	db 27h			; DATA XREF: _output+5Er
		align 4
		dd 2 dup(0B044h), 0
dword_40A020	dd 0FFFFFFFFh, 401467h,	40147Bh, 0 ; DATA XREF:	mainCRTStartup+2o
__lookuptable	db 6			; DATA XREF: _output:loc_40167Er
...
??_C@_0BH@DNAGHKFM@?$DMprogram?5name?5unknown?$DO?$AA@ db '<program name unknown>',0
		...
		dd 0
		align 10h
dword_40A4D0	dd 0FFFFFFFFh, 402A2Ch,	402A30h, 0 ; DATA XREF:	_RTC_Initialize+2o
dword_40A4E0	dd 0FFFFFFFFh, 402A70h,	402A74h, 0 ; DATA XREF:	_RTC_Terminate+2o
...
_wctype		dd 200000h, 4 dup(200020h), 280068h, 280028h, 200028h
		...
		dd 0
dword_40A9F8	dd 0FFFFFFFFh, 4030A3h,	4030A7h	; DATA XREF: report_failure+2o
...
??_C@_0BJ@MDEKIEOJ@Buffer?5overrun?5detected?$CB?$AA@ db 'Buffer overrun detected!',0
					; DATA XREF: __security_error_handler:loc_405347o
		dd 0
		align 10h
...
??_C@_0CD@GMKACBEK@Unknown?5security?5failure?5detecte@	db 'Unknown security failure detected!',0
		...
		align 4
dword_40AC18	dd 0FFFFFFFFh, 405322h,	405326h	; DATA XREF: __security_error_handler+5o
??_C@_13NOLLCAOD@?$AA?$AA?$AA?$AA@ dd 0	; DATA XREF: __crtLCMapStringA+1Co
					; __crtGetStringTypeA+1Eo
dword_40AC28	dd 0FFFFFFFFh, 4059C5h,	4059C9h, 0FFFFFFFFh, 4057C2h, 4057C6h
					; DATA XREF: __crtLCMapStringA+2o
		dd 0FFFFFFFFh, 405890h,	405894h, 0
dword_40AC50	dd 0FFFFFFFFh, 405B61h,	405B65h, 0 ; DATA XREF:	__crtGetStringTypeA+2o
dword_40AC60	dd 0FFFFFFFFh, 4064E5h,	4064E9h, 0 ; DATA XREF:	__convertcp+2o
_load_config_used dd 48h, 0Eh dup(0), 40CF30h, 40B180h,	2, 0E3h	dup(0),	53445352h
		dd 56837B25h, 4492351Ah, 0A4D51EADh, 538A6A93h,	2, 545C3A43h
		dd 5C706D65h, 702E3276h, 6264h,	45h dup(0)
__safe_se_handler_table	dd 2BCCh, 4C3Ch, 41h dup(0)
__rtc_iaa	dd 0
dword_40B290	dd 40h dup(0)		; DATA XREF: _RTC_Initialize+Co
__rtc_izz	dd 41h dup(0)		; DATA XREF: _RTC_Initialize:loc_402A12o
__rtc_taa	dd 0
dword_40B498	dd 40h dup(0)		; DATA XREF: _RTC_Terminate+Co
__rtc_tzz	dd 29Ah	dup(0)		; DATA XREF: _RTC_Terminate:loc_402A56o
_rdata		ends
...
dword_40CBA0	dd 3 dup(0), 2 dup(2), 7 dup(0)	; DATA XREF: _stbuf:loc_4014BFo
					; _flsbuf+5Bo
dword_40CBD0	dd 84h dup(0)		; DATA XREF: __initstdio+9Ao
rterrs		dd 2			; DATA XREF: __initstdio+67o
					; _NMSG_WRITE:loc_4020C3r ...
...
_fpecode	dd 8Ch			; DATA XREF: _XcptFilter+B2r
					; _XcptFilter+BAw ...
__badioinfo	dd 0FFFFFFFFh, 0A80h	; DATA XREF: _flsbuf:loc_402F83o
_amblksiz	dd 10h,	0
...
off_40CF1C	dd offset _fptrap	; DATA XREF: _output+491r
		dd offset _fptrap
		dd offset _fptrap
_pctype		dd 40A5F0h		; DATA XREF: _output:loc_40182Er
					; __pctype_funcr ...
...
__rgctypeflag	db 1			; DATA XREF: _setmbcp+120r
		dd 80402h
		align 4
__rgcode_page_info dd 3A4h		; DATA XREF: _setmbcp:loc_4037B9r
...
__mb_cur_max	dd 1			; DATA XREF: wctomb+30r
					; _ismbcspace:loc_406802r
__decimal_point	dd 2Eh
__decimal_point_length dd 1
errtable	dd 1			; DATA XREF: _dosmaperr:loc_405F98r
dword_40D064	dd 16h			; DATA XREF: _dosmaperr:loc_405FBCr
...
_aenvptr	dd 0			; DATA XREF: mainCRTStartup+11Aw
					; _setenvp:loc_40244Cr	...
_wenvptr	dd 0
__error_mode	dd 0			; DATA XREF: _amsg_exitr
					; fast_error_exitr ...
_stdbuf		dd 2 dup(0)
_cflush		dd 0			; DATA XREF: _stbuf:loc_4014CAw
					; _getbufw
errno		dd 0			; DATA XREF: wctomb:loc_40306Aw
					; _write:loc_405113w ...
...
__argv		dd 0			; DATA XREF: mainCRTStartup+162r
					; _setargv+95w
__wargv		dd 0
_environ	dd 0			; DATA XREF: mainCRTStartup:loc_401431r
					; _setenvp+48w	...
...
dword_40D614	dd 0			; DATA XREF: wctomb:loc_403025r
...
_mbcasemap	db 0			; DATA XREF: setSBUpLow:loc_4036C4w
					; setSBUpLow:loc_4036E1w ...
		dd 3Fh dup(0)
		align 10h
...
; __declspec(dllimport)	__stdcall GetCommandLineA()
		extrn __imp__GetCommandLineA@0:dword ; DATA XREF: mainCRTStartup:loc_4013E4r
					; GetCommandLineA()r
...
; __declspec(dllimport)	__stdcall GetEnvironmentStrings()
		extrn __imp__GetEnvironmentStrings@0:dword
					; DATA XREF: __crtGetEnvironmentStringsA:loc_4027E6r
...
; __declspec(dllimport)	__stdcall SetStdHandle(x,x)
		extrn __imp__SetStdHandle@8:dword ; DATA XREF: _set_osfhnd:loc_406178r
					; _free_osfhnd:loc_4061F2r ...
