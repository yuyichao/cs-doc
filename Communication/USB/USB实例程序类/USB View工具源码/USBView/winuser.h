...
BOOL
WINAPI
GetProcessDefaultLayout(OUT DWORD *pdwDefaultLayout);

WINUSERAPI
BOOL
WINAPI
SetProcessDefaultLayout(IN DWORD dwDefaultlayout);
...
#endif // (_WIN32_WINDOWS >=0x0500)
#if (_WIN32_WINDOWS >= 0x045A)
#define SPI_GETCLEARTYPE         116
#define SPI_SETCLEARTYPE         117
#endif // (_WIN32_WINDOWS >= 0x045A)
